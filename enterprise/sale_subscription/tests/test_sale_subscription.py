...
from incore.addons.sale_subscription.tests.common_sale_subscription import TestSubscriptionCommon
from incore.tests import tagged, Form
...
class TestSubscription(TestSubscriptionCommon):
    ...
    @mute_logger('incore.addons.base.models.ir_model', 'incore.models')
    ...
    def test_auto_payment_with_token(self):
        ...
        patchers = [
            patch('incore.addons.sale_subscription.models.sale_subscription.SaleSubscription._prepare_invoice_line', wraps=self._mock_prepare_invoice_line, create=True),
            patch('incore.addons.sale_subscription.models.sale_subscription.SaleSubscription._prepare_invoice_data', wraps=self._mock_prepare_invoice_data, create=True),
            patch('incore.addons.sale_subscription.models.sale_subscription.SaleSubscription._do_payment', wraps=self._mock_subscription_do_payment, create=True),
            patch('incore.addons.sale_subscription.models.sale_subscription.SaleSubscription.send_success_mail', wraps=self._mock_subscription_send_success_mail, create=True),
        ]
