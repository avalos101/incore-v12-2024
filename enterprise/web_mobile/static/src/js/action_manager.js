incore.define('web_mobile.ActionManager', function (require) {
"use strict";
...
/*
    We don't want to open website urls in the inCore apps (iOS and Android).
    The apps detect the redirection and open the url in a seprate browser.

    In inCore desktop, the redirection occurs in the same tab and the returned
    deferred is never resolved.
    This override returns a resolved deffered in case of mobile app redirects
    because inCore is not aware of this and we need to reactivate status button.
