...
try:
    from incore.tools.misc import xlsxwriter
except ImportError:
    # TODO saas-17: remove the try/except to directly import from misc
    import xlsxwriter

from incore import models, fields, api, _
from incore.tools import DEFAULT_SERVER_DATE_FORMAT, pycompat, config, date_utils
from incore.osv import expression
from babel.dates import get_quarter_names, parse_date
from incore.tools.misc import formatLang, format_date, get_user_companies
from incore.addons.web.controllers.main import clean_action
