incore.define('account_reports.account_report', function (require) {
'use strict';
...
var accountReportsWidget = AbstractAction.extend(ControlPanelMixin, {
    ...
    init: function(parent, action) {
        ...
        this.incore_context = action.context;
    ...
    parse_reports_informations: function(values) {
        ...
        this.incore_context = values.context;
    ...
    trigger_action: function(e) {
        ...
        var context = new Context(this.incore_context, params.actionContext || {}, {active_id: id});
