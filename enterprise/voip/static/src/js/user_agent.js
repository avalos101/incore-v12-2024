incore.define('voip.user_agent', function (require) {
"use strict";
    ...
    */
    ...
    _sendNotification: function (title, content) {
        if (window.Notification && Notification.permission === "granted") {
            return new Notification(title,
                {body: content, icon: "/mail/static/src/img/incore_o.png", silent: true});
        }
    },
    /**
    ...
    _onInvite: function (inviteSession) {
        ...
        this._rpc({
            ...
            self.notification = self._sendNotification('inCore', content);
