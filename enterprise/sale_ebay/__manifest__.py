...
The eBay integrator gives you the opportunity to manage your inCore's products on eBay.
...
* Automatic creation of sales order and invoices
  ...
  # Check https://github.com/incore/incore/blob/master/incore/addons/base/data/ir_module_category_data.xml
  # for the full list
  'category': 'Sales',
  'version': '1.0',
