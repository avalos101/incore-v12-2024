...
from incore import api, tools, SUPERUSER_ID
# TODO: Add after merge https://github.com/incore/enterprise/pull/1617
# from incore.addons.l10n_mx_edi.hooks import _load_xsd_files
import requests
...
def _load_xsd_files(cr, registry, url):
    ...
    # https://github.com/incore/enterprise/pull/1617
    fname = url.split('/')[-1]
    try:
