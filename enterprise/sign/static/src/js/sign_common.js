incore.define('sign.PDFIframe', function (require) {
    'use strict';
...
incore.define('sign.Document', function (require) {
    'use strict';
...
incore.define('sign.utils', function (require) {
    'use strict';
...
// Signing part
incore.define('sign.document_signing', function(require) {
    'use strict';
