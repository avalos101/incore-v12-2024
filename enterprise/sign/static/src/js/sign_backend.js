incore.define('sign.views_custo', function(require) {
    'use strict';
...
incore.define('sign.template', function(require) {
    'use strict';
...
incore.define('sign.DocumentBackend', function (require) {
    'use strict';
...
incore.define('sign.document_edition', function(require) {
    'use strict';
...
incore.define('sign.document_signing_backend', function(require) {
    'use strict';
