...
from incore.tools import DEFAULT_SERVER_TIME_FORMAT
from incore.tools.float_utils import float_compare
from incore.tools.misc import html_escape
from incore.exceptions import UserError

from . import account_invoice

from incore.addons.l10n_mx_edi.tools.run_after_commit import run_after_commit
...
class AccountPayment(models.Model):
    ...
    def l10n_mx_edi_is_required(self):
        ...
        if self.invoice_ids and not self.invoice_ids.filtered(
            ...
            messages.append(_(
                ...
                '<a href="https://www.incore.co/documentation/user/11.0/es/accounting/localizations/mexico.html#payments-just-available-for-cfdi-3-3">'
                'inCore documentation</a> to know how to indicate the payment '
    ...
    def l10n_mx_edi_update_pac_status(self):
        """Synchronize both systems: inCore & PAC if the invoices need to be
        signed or cancelled."""
        # TODO - Duplicated
        for record in self:
    ...
    def l10n_mx_edi_update_sat_status(self):
        """Synchronize both systems: inCore & SAT to make sure the invoice is valid.
        """
