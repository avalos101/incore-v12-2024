...
from incore import models, api, fields, SUPERUSER_ID
from incore.exceptions import AccessError, UserError
...
class YodleeProviderAccount(models.Model):
    ...
    def _get_yodlee_credentials(self):
        ...
        url = 'https://onlinesync.incore.co/yodlee/api/2'
        fastlink_url = 'https://usyirestmasternode.yodleeinteractive.com/authenticate/incoreinc/?channelAppName=usyirestmaster'
    ...
    def get_error_from_code(self, code):
        return {
            ...
            '423': _("No Account Found (423): We were unable to detect an account. Please verify that you account information is available at this time and If the problem persists, please contact customer support at online@incore.co for further assistance."),
...
class YodleeAccount(models.Model):
    ...
    '''
    The yodlee account that is saved in inCore.
