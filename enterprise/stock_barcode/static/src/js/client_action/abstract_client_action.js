incore.define('stock_barcode.ClientAction', function (require) {
'use strict';
...
var ClientAction = AbstractAction.extend({
    ...
    *
    ...
    /**
     * Handles the `exit` inCoreEvent. We disable the fullscreen mode and trigger_up an
     * `history_back`.
     *
     * @private
     * @param {inCoreEvent} ev
     */
     _onExit: function (ev) {
        ev.stopPropagation();
        var self = this;
    ...
    /**
     * Handles the `add_product` inCoreEvent. It destroys `this.linesWidget` and displays an instance
    ...
    /**
     * Handles the `edit_product` inCoreEvent. It destroys `this.linesWidget` and displays an instance
     * of `ViewsWidget` for the line model.
     *
    ...
    /**
     * Handles the `show_information` inCoreEvent. It hides the main widget and
    ...
    /**
     * Handles the `show_settings` inCoreEvent. It hides `this.linesWidget` and dipslays
     * `this.settinsWidget`.
     *
     * @private
     * @param {inCoreEvent} ev
    ...
    /**
     * Handles the `reload` inCoreEvent.
     * Currently, this event is only triggered by `this.ViewsWidget`.
     *
     * @private
     * @param {inCoreEvent} ev ev.data could contain res_id
     */
    ...
    /**
     * Handles the `next_move` inCoreEvent. It makes `this.linesWidget` display
    ...
    /**
     * Handles the `previous_move` inCoreEvent. It makes `this.linesWidget` display
    ...
    /**
     * Handles the 'main_menu' inCoreEvent. It's used when we want to go back the
     * main app menu.
     * @private
     */
