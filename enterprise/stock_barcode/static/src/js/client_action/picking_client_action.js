incore.define('stock_barcode.picking_client_action', function (require) {
'use strict';
...
var PickingClientAction = ClientAction.extend({
    ...
    /**
     * Handles the `open_package` inCoreEvent. It hides the main widget and
    ...
    /**
     * Handles the `validate` inCoreEvent. It makes an RPC call
    ...
    /**
     * Handles the `cancel` inCoreEvent. It makes an RPC call
    ...
    /**
     * Handles the `print_picking` inCoreEvent. It makes an RPC call
    ...
    /**
     * Handles the `print_delivery_slip` inCoreEvent. It makes an RPC call
    ...
    /**
     * Handles the `scan` inCoreEvent. It makes an RPC call
    ...
    /**
     * Handles the `Put in pack` inCoreEvent. It makes an RPC call
