incore.define('stock_barcode.inventory_client_action', function (require) {
'use strict';
...
var InventoryClientAction = ClientAction.extend({
    ...
    /**
     * Handles the `validate` inCoreEvent.
     *
     * @private
    ...
    /**
    * Handles the `cancel` inCoreEvent.
    *
    * @private
    * @param {inCoreEvent} ev
    */
    ...
    /**
     * Handles the `print_inventory` inCoreEvent. It makes an RPC call
