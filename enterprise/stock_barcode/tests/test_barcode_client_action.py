...
from incore.tests import HttpCase, tagged
...
class TestPickingBarcodeClientAction(TestBarcodeClientAction):
    def test_internal_picking_from_scratch_1(self):
        ...
        with patch('incore.addons.stock.models.stock_picking.Picking.write', new=picking_write_mock):
            self.phantom_js(
                url,
                "incore.__DEBUG__.services['web_tour.tour'].run('test_internal_picking_from_scratch_1')",
                "incore.__DEBUG__.services['web_tour.tour'].tours.test_internal_picking_from_scratch_1.ready",
                login='admin',
                timeout=180,
            )
    ...
    def test_internal_picking_from_scratch_2(self):
        ...
        self.phantom_js(
            url,
            "incore.__DEBUG__.services['web_tour.tour'].run('test_internal_picking_from_scratch_2')",
            "incore.__DEBUG__.services['web_tour.tour'].tours.test_internal_picking_from_scratch_2.ready",
            login='admin',
            timeout=180,
        )
    ...
    def test_internal_picking_reserved_1(self):
        ...
        with patch('incore.addons.stock.models.stock_picking.Picking.write', new=picking_write_mock):
            self.phantom_js(
                url,
                "incore.__DEBUG__.services['web_tour.tour'].run('test_internal_picking_reserved_1')",
                "incore.__DEBUG__.services['web_tour.tour'].tours.test_internal_picking_reserved_1.ready",
                login='admin',
                timeout=180,
            )
    ...
    def test_receipt_from_scratch_with_lots_1(self):
        ...
        self.phantom_js(
            url,
            "incore.__DEBUG__.services['web_tour.tour'].run('test_receipt_from_scratch_with_lots_1')",
            "incore.__DEBUG__.services['web_tour.tour'].tours.test_receipt_from_scratch_with_lots_1.ready",
            login='admin',
            timeout=180,
        )
    ...
    def test_receipt_from_scratch_with_lots_2(self):
        ...
        self.phantom_js(
            url,
            "incore.__DEBUG__.services['web_tour.tour'].run('test_receipt_from_scratch_with_lots_2')",
            "incore.__DEBUG__.services['web_tour.tour'].tours.test_receipt_from_scratch_with_lots_2.ready",
            login='admin',
            timeout=180,
        )
        self.assertEqual(receipt_picking.move_line_ids.mapped('lot_name'), ['lot1', 'lot2'])
    ...
    def test_receipt_reserved_1(self):
        ...
        with patch('incore.addons.stock.models.stock_picking.Picking.write', new=picking_write_mock):
            self.phantom_js(
                url,
                "incore.__DEBUG__.services['web_tour.tour'].run('test_receipt_reserved_1')",
                "incore.__DEBUG__.services['web_tour.tour'].tours.test_receipt_reserved_1.ready",
                login='admin',
                timeout=180,
            )
    ...
    def test_delivery_reserved_1(self):
        ...
        with patch('incore.addons.stock.models.stock_picking.Picking.write', new=picking_write_mock):
            self.phantom_js(
                url,
                "incore.__DEBUG__.services['web_tour.tour'].run('test_delivery_reserved_1')",
                "incore.__DEBUG__.services['web_tour.tour'].tours.test_delivery_reserved_1.ready",
                login='admin',
                timeout=180,
            )
            self.assertEqual(CALL_COUNT, 1)
    ...
    def test_delivery_reserved_2(self):
        ...
        with patch('incore.addons.stock.models.stock_picking.Picking.write', new=picking_write_mock):
            self.phantom_js(
                url,
                "incore.__DEBUG__.services['web_tour.tour'].run('test_delivery_reserved_2')",
                "incore.__DEBUG__.services['web_tour.tour'].tours.test_delivery_reserved_2.ready",
                login='admin',
                timeout=180,
            )
    ...
    def test_delivery_reserved_3(self):
        ...
        with patch('incore.addons.stock.models.stock_picking.Picking.write', new=picking_write_mock):
            self.phantom_js(
                url,
                "incore.__DEBUG__.services['web_tour.tour'].run('test_delivery_reserved_3')",
                "incore.__DEBUG__.services['web_tour.tour'].tours.test_delivery_reserved_3.ready",
                login='admin',
                timeout=180,
            )
            self.assertEqual(CALL_COUNT, 0)
    ...
    def test_delivery_from_scratch_1(self):
        ...
        self.phantom_js(
            url,
            "incore.__DEBUG__.services['web_tour.tour'].run('test_delivery_from_scratch_with_lots_1')",
            "incore.__DEBUG__.services['web_tour.tour'].tours.test_delivery_from_scratch_with_lots_1.ready",
            login='admin',
            timeout=180,
        )
    ...
    def test_delivery_from_scratch_sn_1(self):
        ...
        self.phantom_js(
            url,
            "incore.__DEBUG__.services['web_tour.tour'].run('test_delivery_from_scratch_with_sn_1')",
            "incore.__DEBUG__.services['web_tour.tour'].tours.test_delivery_from_scratch_with_sn_1.ready",
            login='admin',
            timeout=180,
        )
    ...
    def test_delivery_reserved_lots_1(self):
        ...
        self.phantom_js(
            url,
            "incore.__DEBUG__.services['web_tour.tour'].run('test_delivery_reserved_lots_1')",
            "incore.__DEBUG__.services['web_tour.tour'].tours.test_delivery_reserved_lots_1.ready",
            login='admin',
            timeout=180,
        )
    ...
    def test_delivery_from_scratch_sn_1(self):
        ...
        self.phantom_js(
            url,
            "incore.__DEBUG__.services['web_tour.tour'].run('test_delivery_reserved_with_sn_1')",
            "incore.__DEBUG__.services['web_tour.tour'].tours.test_delivery_reserved_with_sn_1.ready",
            login='admin',
            timeout=180,
        )
    ...
    def test_receipt_reserved_lots_multiloc_1(self):
        ...
        self.phantom_js(
            url,
            "incore.__DEBUG__.services['web_tour.tour'].run('test_receipt_reserved_lots_multiloc_1')",
            "incore.__DEBUG__.services['web_tour.tour'].tours.test_receipt_reserved_lots_multiloc_1.ready",
            login='admin',
            timeout=180,
        )
    ...
    def test_pack_multiple_scan(self):
        ...
        self.phantom_js(
            url,
            "incore.__DEBUG__.services['web_tour.tour'].run('test_pack_multiple_scan')",
            "incore.__DEBUG__.services['web_tour.tour'].tours.test_pack_multiple_scan.ready",
            login='admin',
            timeout=180,
        )
    ...
    def test_pack_common_content_scan(self):
        ...
        self.phantom_js(
            url,
            "incore.__DEBUG__.services['web_tour.tour'].run('test_pack_common_content_scan')",
            "incore.__DEBUG__.services['web_tour.tour'].tours.test_pack_common_content_scan.ready",
            login='admin',
            timeout=180,
        )
    ...
    def test_pack_multiple_location(self):
        ...
        self.phantom_js(
            url,
            "incore.__DEBUG__.services['web_tour.tour'].run('test_pack_multiple_location')",
            "incore.__DEBUG__.services['web_tour.tour'].tours.test_pack_multiple_location.ready",
            login='admin',
            timeout=180,
        )
    ...
    def test_put_in_pack_from_multiple_pages(self):
        ...
        self.phantom_js(
            url,
            "incore.__DEBUG__.services['web_tour.tour'].run('test_put_in_pack_from_multiple_pages')",
            "incore.__DEBUG__.services['web_tour.tour'].tours.test_put_in_pack_from_multiple_pages.ready",
            login='admin',
            timeout=180,
        )
    ...
    def test_reload_flow(self):
        ...
        self.phantom_js(
            url,
            "incore.__DEBUG__.services['web_tour.tour'].run('test_reload_flow')",
            "incore.__DEBUG__.services['web_tour.tour'].tours.test_reload_flow.ready",
            login='admin',
            timeout=180,
        )
    ...
    def test_duplicate_serial_number(self):
        ...
        self.phantom_js(
            url,
            "incore.__DEBUG__.services['web_tour.tour'].run('test_receipt_duplicate_serial_number')",
            "incore.__DEBUG__.services['web_tour.tour'].tours.test_receipt_duplicate_serial_number.ready",
            login='admin',
            timeout=180,
        )
        ...
        self.phantom_js(
            url,
            "incore.__DEBUG__.services['web_tour.tour'].run('test_delivery_duplicate_serial_number')",
            "incore.__DEBUG__.services['web_tour.tour'].tours.test_delivery_duplicate_serial_number.ready",
            login='admin',
            timeout=180,
        )
    ...
    def test_bypass_source_scan(self):
        ...
        self.phantom_js(
            url,
            "incore.__DEBUG__.services['web_tour.tour'].run('test_bypass_source_scan')",
            "incore.__DEBUG__.services['web_tour.tour'].tours.test_bypass_source_scan.ready",
            login='admin',
            timeout=180,
        )
    ...
    def test_put_in_pack_from_different_location(self):
        ...
        self.phantom_js(
            url,
            "incore.__DEBUG__.services['web_tour.tour'].run('test_put_in_pack_from_different_location')",
            "incore.__DEBUG__.services['web_tour.tour'].tours.test_put_in_pack_from_different_location.ready",
            login='admin',
            timeout=180,
        )
        pack = self.env['stock.quant.package'].search([])[-1]
    ...
    def test_put_in_pack_before_dest(self):
        ...
        self.phantom_js(
            url,
            "incore.__DEBUG__.services['web_tour.tour'].run('test_put_in_pack_before_dest')",
            "incore.__DEBUG__.services['web_tour.tour'].tours.test_put_in_pack_before_dest.ready",
            login='admin',
            timeout=180,
        )
        pack = self.env['stock.quant.package'].search([])[-1]
    ...
    def test_highlight_packs(self):
        ...
        self.phantom_js(
            url,
            "incore.__DEBUG__.services['web_tour.tour'].run('test_highlight_packs')",
            "incore.__DEBUG__.services['web_tour.tour'].tours.test_highlight_packs.ready",
            login='admin',
            timeout=180,
        )
...
class TestInventoryAdjustmentBarcodeClientAction(TestBarcodeClientAction):
    def test_inventory_adjustment(self):
        ...
        self.phantom_js(
            url,
            "incore.__DEBUG__.services['web_tour.tour'].run('test_inventory_adjustment')",
            "incore.__DEBUG__.services['web_tour.tour'].tours.test_inventory_adjustment.ready",
            login='admin',
            timeout=180,
        )
    ...
    def test_inventory_adjustment_mutli_location(self):
        ...
        self.phantom_js(
            url,
            "incore.__DEBUG__.services['web_tour.tour'].run('test_inventory_adjustment_mutli_location')",
            "incore.__DEBUG__.services['web_tour.tour'].tours.test_inventory_adjustment_mutli_location.ready",
            login='admin',
            timeout=180,
        )
    ...
    def test_inventory_adjustment_tracked_product(self):
        ...
        self.phantom_js(
            url,
            "incore.__DEBUG__.services['web_tour.tour'].run('test_inventory_adjustment_tracked_product')",
            "incore.__DEBUG__.services['web_tour.tour'].tours.test_inventory_adjustment_tracked_product.ready",
            login='admin',
            timeout=180,
        )
    ...
    def test_inventory_nomenclature(self):
        ...
        self.phantom_js(
            url,
            "incore.__DEBUG__.services['web_tour.tour'].run('test_inventory_nomenclature')",
            "incore.__DEBUG__.services['web_tour.tour'].tours.test_inventory_nomenclature.ready",
            login='admin',
            timeout=180,
        )
