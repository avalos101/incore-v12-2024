import random
import textwrap
from incore.http import _request_stack
from incore.tests.common import TransactionCase
from incore.addons.web_studio.controllers.main import WebStudioController
                ...
                <sheet>
                    ...
                    <group>
                        <group>
                            ...
                            <field name="website" widget="url" placeholder="e.g. www.incore.co"/>
                        </group>
                        <group>
