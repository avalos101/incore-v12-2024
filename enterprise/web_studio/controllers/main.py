...
from incore.http import content_disposition, request
from incore.exceptions import UserError, AccessError, ValidationError
from incore.addons.web_studio.controllers import export
from incore.tools import ustr
...
class WebStudioController(http.Controller):
    ...
    def _generate_studio_view_name(self, view):
        return "inCore Studio: %s customization" % (view.name)
