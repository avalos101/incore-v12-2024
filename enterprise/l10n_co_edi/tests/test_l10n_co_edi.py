...
from incore.tools import misc, mute_logger
...
class InvoiceTransactionCase(AccountingTestCase):
    ...
    def _validate_and_compare(self, invoice, invoice_number, filename_expected):
        ...
        with patch('incore.addons.l10n_co_edi.models.carvajal_request.CarvajalRequest.upload', new=Mock(return_value=return_value)):
            invoice.action_invoice_open()
    ...
    def test_invoice(self):
        ...
        with mute_logger('incore.addons.account.models.account_invoice'):
