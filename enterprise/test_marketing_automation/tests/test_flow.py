...
from incore.addons.base.models.ir_mail_server import IrMailServer
from incore.fields import Datetime
from incore.tools import mute_logger

from incore.addons.test_marketing_automation.tests.common import MarketingCampaignTestBase
...
for record in records:
    ...
    @mute_logger('incore.addons.base.ir.ir_model', 'incore.models')
