...
#
echo "Creating 'www' bundle for cordova app in directory inCoreTimesheets"

./generate_extension.sh

cordova create inCoreTimesheets com.incore.inCoreTimesheets inCoreTimesheets
cd inCoreTimesheets
...
app_author='inCore.'
app_author_email='help@incore.co'
app_author_website='https://www.incore.co/'
