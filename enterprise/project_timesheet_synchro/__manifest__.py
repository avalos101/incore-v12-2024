...
If you use the external timesheet application, this module alows you to synchronize timesheet entries between inCore and the application.
    """,
    'website': 'https://www.incore.co/page/project-management',
