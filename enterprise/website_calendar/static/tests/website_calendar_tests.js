incore.define('website_calendar.tests', function (require) {
"use strict";
...
QUnit.module('website_calendar', {
    ...
    QUnit.test("empty previous_order widget", function (assert) {
        ...
        var form = createView({
            ...
            res_id: 1,
            session: {
                'web.base.url': 'http://amazing.incore.co',
            },
            model: 'calendar.appointment.type',
        });

        assert.strictEqual(form.$('.o_form_uri').attr('href'),
            'http://amazing.incore.co/website/calendar/schedule-a-demo-1?employee_id=214',
    ...
    QUnit.test("new record appointment_employee_url widget", function (assert) {
        ...
        form.$('.o_form_uri').each(function (i,r) {
            var link = "";
            if (i === 1) {
                link = "http://amazing.incore.co/aaa/aaa/?employee_id=216"
            } else {
                link = "http://amazing.incore.co/aaa/aaa/?employee_id=214"
            }
