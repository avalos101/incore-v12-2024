incore.define('pos_blackbox_be.pos_blackbox_be', function (require) {
...
can no longer be modified. Please create a new line with eg. a negative quantity."),
    ...
    models.PosModel = models.PosModel.extend({
        ...
        push_order_to_blackbox: function (order) {
            ...
            var def = this.proxy.request_fdm_hash_and_sign(packet).then(function (parsed_response) {
                ...
                if (parsed_response) {
                    ...
                    order.blackbox_pos_version = "inCore " + self.version.server_version + "1807BE_FDM";
        ...
        get_blackbox_terminal_id: function () {
            if (! localStorage['incore_pos_blackbox_pos_production_id']) {
                ...
                localStorage['incore_pos_blackbox_pos_production_id'] = production_id;
            }

            return localStorage['incore_pos_blackbox_pos_production_id'];
        },
