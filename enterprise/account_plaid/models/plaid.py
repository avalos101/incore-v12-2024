...
from incore.tools import DEFAULT_SERVER_DATE_FORMAT, DEFAULT_SERVER_DATETIME_FORMAT, date_utils
...
class PlaidProviderAccount(models.Model):
    ...
    def _get_plaid_credentials(self):
        ...
        url = 'https://onlinesync.incore.co/plaid/api/2'
    ...
    def plaid_fetch(self, url, data):
        ...
        try:
            ...
            # This is only intended to work with inCore proxy, if user wants to use his own plaid account
