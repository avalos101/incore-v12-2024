incore.define('web_enterprise.HomeMenu', function (require) {
"use strict";
...
incore.define('web_enterprise.ExpirationPanel', function (require) {
"use strict";
...
HomeMenu.include({
    ...
    _onEnterpriseBuy: function () {
        ...
        this._rpc({
            ...
            .then(function (users) {
                window.location =
                    $.param.querystring("https://www.incore.co/incore-enterprise/upgrade", {num_users: users});
            });
    },
    /**
     * @private
                    ...
                    .then(function () {
                        $.when(
                            ...
                            if (newDate !== oldDate && mtNewDate > new moment()) {
                                ...
                                window.location =
                                    $.param.querystring("https://www.incore.co/incore-enterprise/renew", params);
                            }
                        });
                    });
            });
            ...
            .then(function (contract) {
                self._rpc({
                    ...
                    .then(function (users) {
                        ...
                        window.location =
                            $.param.querystring("https://www.incore.co/incore-enterprise/upsell", params);
                    });
            });
    },
});
