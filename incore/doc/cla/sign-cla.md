...
In order for your contribution to inCore to be accepted, you have to sign the
inCore Contributor License Agreement (CLA). More information about this
...
2.  Modify your current pull request, or make a new pull request on
    [incore/incore](/incore/incore), adding a new file `<github-login>.md` under the
...
3. An inCore R&D Team member will verify and accept your Pull Request. You can
...
2.  Modify your current pull request, or make a new pull request on
    [incore/incore](/incore/incore), adding a new file `<lowercase-company-name>.md`
    under the [`doc/cla/corporate`](corporate/) directory.
    If the name of the company is inCore, the file would be
    `doc/cla/corporate/incore.md`. The file should contain:

```
<country>, <date>

<company-name> agrees to the terms of the inCore Corporate Contributor License
Agreement v1.0.
...
`cla-submission` `at` `incore.co`.  In that case someone from the inCore team will
make the pull request on your behalf.

* Printable inCore CCLA v1.0 https://www.incore.co/files/legal/inCore-CCLA-v1.0.pdf
* Printable inCore ICLA v1.0 https://www.incore.co/files/legal/inCore-ICLA-v1.0.pdf

# FAQ

## Why do I need to accept a CLA ?

The goal of having a Contributor License Agreement for inCore is to:

* clearly define the terms under which intellectual property (patches, pull
  requests, etc.) have been contributed to the inCore project

* protect the inCore project and its users in case of legal dispute about the
  origin or ownership of any part of the code

* protect the inCore project and its users from bad actors who would contribute
...
contributor really intended to contribute to the inCore project under specific
...
The inCore CLA is based on the Apache Software Foundation CLA v2.0, as
...
irrevocable license to the project maintainer, inCore. to use, modify and
...
(ICLA) of inCore.  The agreement is executed by adding your name and
...
removed from the inCore project.
