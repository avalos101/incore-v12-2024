...
def test_single():
     ...
     */
    incore.define('supermodule', function (req) {
        var other = req('other');
    });
    """)
...
def test_multiple():
    ...
    incore.define('module1', function (req) {
        return 1;
    });
    incore.define('module2', function (req) {
        return req('dep2');
    });
    incore.define('module3', function (req) {
        var r = req('dep3');
        return r;
    });
    """)
...
def test_func():
    [mod] = parse("""
    incore.define('module', function (d) {
        /**
...
def test_export_instance():
    [mod] = parse("""
    incore.define('module', function (require) {
...
def test_bounce():
    [m2, m1] = parse("""
    incore.define('m2', function (require) {
        var Item = require('m1');
        return {
            Item: Item
        };
    });
    incore.define('m1', function (require) {
        var Class = require('Class');
...
def test_reassign():
    [m] = parse("""
    incore.define('m', function (require) {
        var Class = require('Class');
        /** local class */
