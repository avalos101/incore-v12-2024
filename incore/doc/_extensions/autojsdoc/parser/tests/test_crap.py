# -*- coding: utf-8 -*-
"""
Test various crap patterns found in inCore code to ensure they don't blow up
the parser thingie
"""
...
def test_prototype():
    ...
    incore.define('mod2', function (require) {
