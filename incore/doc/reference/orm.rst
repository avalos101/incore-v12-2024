...
.. versionadded:: 8.0
    ...
    This page documents the New API added in inCore 8.0 which should be the
...
Accessing a relational field (:class:`~incore.fields.Many2one`,
:class:`~incore.fields.One2many`, :class:`~incore.fields.Many2many`)
...
.. danger::
    ...
    (to the same value), use :meth:`~incore.models.Model.write`::
...
inCore maintains a cache for the fields of the records, so that not every field
...
To avoid reading one field on one record at a time, inCore *prefetches* records
...
:meth:`~incore.models.Model.filtered`
...
:meth:`~incore.models.Model.sorted`
...
:meth:`~incore.models.Model.mapped`
...
The :class:`~incore.api.Environment` stores various contextual data used by
...
using :attr:`~incore.models.Model.env` and gives access to the current user
(:attr:`~incore.api.Environment.user`), the cursor
(:attr:`~incore.api.Environment.cr`) or the context
(:attr:`~incore.api.Environment.context`)::
...
:meth:`~incore.models.Model.with_context`
...
:meth:`~incore.models.Model.with_env`
...
:meth:`~incore.models.Model.search`
   ...
   .. tip:: to just check if any record matches a domain, or count the number
             ...
             :meth:`~incore.models.Model.search_count`

:meth:`~incore.models.Model.create`
...
:meth:`~incore.models.Model.exists`
...
:meth:`~incore.api.Environment.ref`
...
:meth:`~incore.models.Model.ensure_one`
...
* computed fields are automatically checked and recomputed, they do not need
  an ``onchange``
* for non-computed fields, the :func:`~incore.api.onchange` decorator is used
...
.. warning::
    ...
    itself via onchange. This is a webclient limitation - see `#2693 <https://github.com/incore/incore/issues/2693>`_.

Low-level SQL
-------------

The :attr:`~incore.api.Environment.cr` attribute on environments is the
...
Because models use the same cursor and the :class:`~incore.api.Environment`
...
:meth:`~incore.models.BaseModel.invalidate_cache` method of the
:class:`~incore.models.BaseModel` object.
...
inCore is currently transitioning from an older (less regular) API, it can be
...
* values of the :class:`~incore.api.Environment` (cursor, user id and
  context) are passed explicitly to methods instead
* record data (:attr:`~incore.models.Model.ids`) are passed explicitly to
...
Note that a method `create` decorated with :func:`~incore.api.model` will always
be called with a single dictionary. A method `create` decorated with the variant
:func:`~incore.api.model_create_multi` will always be called with a list of dicts.
...
.. currentmodule:: incore.models

.. autoclass:: incore.models.Model
    ...
    .. attribute:: _auto
     ...
     .. tip:: To create a model without any table, inherit
              from ``incore.models.AbstractModel``

    .. attribute:: _table

        Name of the table backing the model created when
        :attr:`~incore.models.Model._auto`, automatically generated by
        default.
    ...
    .. attribute:: _inherits
        ...
        the fields of the :attr:`~incore.models.Model._inherits`-ed model but
        ...
        .. warning::
            ...
            :attr:`~incore.models.Model._inherits`-ed
    ...
    .. attribute:: _constraints
        ...
        .. deprecated:: 8.0
            ...
            use :func:`~incore.api.constrains`
    ...
    .. attribute:: id
        ...
        Identifier :class:`field <incore.fields.Field>`
    ...
    .. attribute:: create_date
        ...
        :type: :class:`~incore.field.Datetime`
    ...
    .. attribute:: active
        ...
        :type: :class:`~incore.fields.Boolean`
    ...
    .. attribute:: sequence
        ...
        :type: :class:`~incore.fields.Integer`

    .. attribute:: state

        lifecycle stages of the object, used by the ``states`` attribute on
        :class:`fields <incore.fields.Field>`

        :type: :class:`~incore.fields.Selection`
    ...
    .. attribute:: parent_id
        ...
        :type: :class:`~incore.fields.Many2one`
...
.. autodoc documents descriptors as attributes, even for the *definition* of
   descriptors. As a result automodule:: incore.fields lists all the field
...
.. autoclass:: incore.fields.Field

.. autoclass:: incore.fields.Char
    :show-inheritance:

.. autoclass:: incore.fields.Boolean
    :show-inheritance:

.. autoclass:: incore.fields.Integer
    :show-inheritance:

.. autoclass:: incore.fields.Float
    :show-inheritance:

.. autoclass:: incore.fields.Text
    :show-inheritance:

.. autoclass:: incore.fields.Selection
    :show-inheritance:

.. autoclass:: incore.fields.Html
    :show-inheritance:
...
application, they are heavily used in many popular inCore applications such as
logistics or accounting and their misuse can create invisible yet painful
bugs, this excerpt aims to provide inCore developers with the knowledge required
...
:func:`~incore.fields.Date.to_date` or :func:`~incore.fields.Datetime.to_datetime`
...
:class:`~incore.fields.Date` and :class:`~incore.fields.Datetime`.
These helpers are also available by importing `incore.tools.date_utils`.

.. autoclass:: incore.fields.Date
    :show-inheritance:
    :members: today, context_today, to_date, to_string, start_of, end_of, add, subtract

.. autoclass:: incore.fields.Datetime
    :show-inheritance:
...
.. autoclass:: incore.fields.Many2one
    :show-inheritance:

.. autoclass:: incore.fields.One2many
    :show-inheritance:

.. autoclass:: incore.fields.Many2many
    :show-inheritance:

.. autoclass:: incore.fields.Reference
    :show-inheritance:
...
inCore provides three different mechanisms to extend models in a modular way:
...
When using the :attr:`~incore.models.Model._inherit` and
:attr:`~incore.models.Model._name` attributes together, inCore creates a new
model using the existing one (provided via
:attr:`~incore.models.Model._inherit`) as a base. The new model gets all the
fields, methods and meta-information (defaults & al) from its base.

.. literalinclude:: ../../incore/addons/test_documentation_examples/inheritance.py
    :language: python
    :lines: 5-

and using them:

.. literalinclude:: ../../incore/addons/test_documentation_examples/tests/test_inheritance.py
    :language: python
    :lines: 10,11,14,19
...
When using :attr:`~incore.models.Model._inherit` but leaving out
:attr:`~incore.models.Model._name`, the new model replaces the existing one,
...
.. literalinclude:: ../../incore/addons/test_documentation_examples/extension.py
    :language: python
    :lines: 7-

.. literalinclude:: ../../incore/addons/test_documentation_examples/tests/test_extension.py
    :language: python
    :lines: 10,15
...
at runtime) but less power: using the :attr:`~incore.models.Model._inherits`
...
:class:`~incore.fields.Reference` fields automatically set up on the parent
model:

.. literalinclude:: ../../incore/addons/test_documentation_examples/delegation.py
    :language: python
    :lines: 5-

.. literalinclude:: ../../incore/addons/test_documentation_examples/tests/test_delegation.py
    :language: python
    :lines: 11-14,23,28
...
``field_name`` (``str``)
    ...
    a :class:`~incore.fields.Many2one` using dot-notation e.g. ``'street'``
...
``operator`` (``str``)
    ...
    ``child_of``
        ...
        :attr:`~incore.models.Model._parent_name`).
...
* :meth:`~incore.models.Model.search` returns a recordset, no point in e.g.
  browsing its result
* ``fields.related`` and ``fields.function`` are replaced by using a normal
  field type with either a ``related=`` or a ``compute=`` parameter
* :func:`~incore.api.depends` on ``compute=`` methods **must be complete**,
...
* the decorators :func:`~incore.api.model` and :func:`~incore.api.multi` are
  for bridging *when calling from the old API context*, for internal or pure
  new-api (e.g. compute) they are useless
* remove :attr:`~incore.models.Model._default`, replace by ``default=``
...
* double check that all fields and methods have different names, there is no
  warning in case of collision (because Python handles it before inCore sees
  anything)
* the normal new-api import is ``from incore import fields, models``. If
  compatibility decorators are necessary, use ``from incore import api,
  fields, models``
* avoid the :func:`~incore.api.one` decorator, it probably does not do what
  you expect
* remove explicit definition of :attr:`~incore.models.Model.create_uid`,
  :attr:`~incore.models.Model.create_date`,
  :attr:`~incore.models.Model.write_uid` and
  :attr:`~incore.models.Model.write_date` fields: they are now created as
...
* when straight conversion is impossible (semantics can not be bridged) or the
  ...
  implementations for the same method name using :func:`~incore.api.v7` and
  :func:`~incore.api.v8`. The method should first be defined using the
  old-API style and decorated with :func:`~incore.api.v7`, it should then be
  re-defined using the exact same name but the new-API style and decorated
  with :func:`~incore.api.v8`. Calls from an old-API context will be
...
* uses of :attr:`~incore.models.Model._columns` or
  :attr:`~incore.models.Model._all_columns` should be replaced by
  :attr:`~incore.models.Model._fields`, which provides access to instances of
  new-style :class:`incore.fields.Field` instances (rather than old-style
  :class:`incore.osv.fields._column`).

  Non-stored computed fields created using the new API style are *not*
  available in :attr:`~incore.models.Model._columns` and can only be
  inspected through :attr:`~incore.models.Model._fields`
* reassigning ``self`` in a method is probably unnecessary and may break
  translation introspection
* :class:`~incore.api.Environment` objects rely on some threadlocal state,
  which has to be set up before using them. It is necessary to do so using the
  :meth:`incore.api.Environment.manage` context manager when trying to use
  the new API in contexts where it hasn't been set up yet, such as new threads
  or a Python interactive environment::

    >>> from incore import api, modules
...
:class:`~incore.api.Environment` (for :attr:`~incore.api.Environment.cr`,
:attr:`~incore.api.Environment.user` and
:attr:`~incore.api.Environment.context`) or the current recordset (for ``id``
and ``ids``).
...
* disabling it entirely, by decorating a method with
  :func:`~incore.api.noguess` there will be no bridging and methods will be
...
* defining the bridge explicitly, this is mostly for methods which are matched
  ...
  (e.g. :func:`~incore.api.cr_uid_context`) which also passes the current
  context *by keyword*.
* dual implementations using :func:`~incore.api.v7` and
  :func:`~incore.api.v8` will be ignored as they provide their own "bridging"
