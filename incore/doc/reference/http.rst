...
.. autofunction:: incore.http.route
...
The request object is automatically set on :data:`incore.http.request` at
the start of the request

.. autoclass:: incore.http.WebRequest
    :members:
    :member-order: bysource
.. autoclass:: incore.http.HttpRequest
    :members:
.. autoclass:: incore.http.JsonRequest
    :members:

Response
========

.. autoclass:: incore.http.Response
    :members:
    :member-order: bysource
...
:class:`~incore.models.Model`, but can't use the same mechanism as the
...
.. autoclass:: incore.http.Controller

and defining methods decorated with :func:`~incore.http.route`::
...
* decorating with :func:`~incore.http.route` is necessary to keep the method
