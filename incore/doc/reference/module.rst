...
The manifest file serves to declare a python package as an inCore module
...
``category`` (``str``, default: ``Uncategorized``)
    classification category within inCore, rough business domain for the module.
...
``depends`` (``list(str)``)
    inCore modules which must be loaded before this one, either because this
...
.. _existing categories:
     https://github.com/incore/incore/blob/12.0/incore/addons/base/data/ir_module_category_data.xml
