...
Step 2: Configure the incore instance with your zone
--------------------------------------------------

In the inCore back end, go to the :guilabel:`Website Settings`: menu, then
...
.. image:: cdn/incore_cdn_base_url.png
   :class: img-responsive
...
.. image:: cdn/incore_check_your_html.png
   :class: img-responsive
...
resulting problem on a default inCore website will be the lack of font-awesome
...
.. image:: cdn/incore_font_file_not_loaded.png
   :class: img-responsive

A security error message will also appear in the browser's console:

.. image:: cdn/incore_security_message.png
   :class: img-responsive
