...
* Enter your inCore Enterprise Subscription code
...
* Stop the incore service

  .. code-block:: console

    $ sudo service incore stop
...
* Update your database to the enterprise packages using
  ...
  .. code-block:: console
    ...
    $ python3 /usr/bin/incore-bin -d <database_name> -i web_enterprise --stop-after-init

* You should be able to connect to your inCore Enterprise instance using your usual mean of identification.
  You can then link your database with your inCore Enterprise Subscription by entering the code you received
...
* Restart your server with the updated addons path of point 3.
  ...
  inCore Enterprise Subscription by entering the code you received by e-mail in the form input
...
* Uninstall inCore Community (using the Uninstall executable in the installation folder) -
  PostgreSQL will remain installed

  .. image:: enterprise/windows_uninstall.png
    :class: img-responsive

* Launch the inCore Enterprise Installer and follow the steps normally. When choosing
  ...
  Uncheck ``Start inCore`` at the end of the installation

  .. image:: enterprise/windows_setup.png
   :class: img-responsive

* Using a command window, update your inCore Database using this command (from the inCore
  installation path, in the server subfolder)

  .. code-block:: console

    $ incore.exe -d <database_name> -i web_enterprise --stop-after-init

* No need to manually launch the server, the service is running.
  You should be able to connect to your inCore Enterprise instance using your usual
  mean of identification. You can then link your database with your inCore Enterprise
