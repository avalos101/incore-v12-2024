...
from incore.tests.common import TransactionCase, can_import
from incore.modules.module import get_module_resource
from incore.tools import mute_logger, pycompat
...
class TestPreview(TransactionCase):
    ...
    @mute_logger('incore.addons.base_import.models.base_import')
