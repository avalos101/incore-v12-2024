...
from incore.modules import load_information_from_description_file
from incore.tools import convert_file, exception_to_unicode, pycompat
from incore.tools.osutil import tempdir
...
class IrModule(models.Model):
    ...
    def _import_module(self, module, path, force=False):
        ...
        if unmet_dependencies:
            ...
            raise UserError(_("Studio customizations require the inCore Studio app."))
    ...
    def import_zipfile(self, module_file, force=False):
        ...
        with zipfile.ZipFile(module_file, "r") as z:
            ...
            with tempdir() as module_dir:
                import incore.modules.module as module
                try:
