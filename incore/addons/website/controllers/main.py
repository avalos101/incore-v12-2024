...
from incore import http, models, fields, _
from incore.http import request
from incore.tools import pycompat, OrderedSet
from incore.addons.http_routing.models.ir_http import slug, _guess_mimetype
from incore.addons.web.controllers.main import Binary
from incore.addons.portal.controllers.portal import pager as portal_pager
...
class Website(Home):
    ...
    def website_info(self, **kwargs):
        ...
        values = {
            'apps': apps,
            'modules': modules,
            'version': incore.service.common.exp_version()
        }
