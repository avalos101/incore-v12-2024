...
import incore
from incore import api, models, registry
...
from incore.osv.expression import FALSE_DOMAIN, OR

from incore.addons.base.models.qweb import QWebException
from incore.addons.http_routing.models.ir_http import ModelConverter, _guess_mimetype
from incore.addons.portal.controllers.portal import _build_url_w_params
...
def get_request_website():
    ...
    ```
    from incore.addons.website.models import ir_http
...
class Http(models.AbstractModel):
    ...
    def _handle_exception(cls, exception):
        ...
        if not is_website_request:
            ...
            if isinstance(exception, incore.exceptions.AccessError):
                code = 403
            ...
            if isinstance(exception, QWebException):
                ...
                if type(exception.error) == incore.exceptions.AccessError:
                    code = 403
