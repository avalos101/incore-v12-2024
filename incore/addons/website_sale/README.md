...
incore is an <a href="https://www.incore.com/page/e-commerce">Open Source eCommerce</a>
...
incore's unique *'edit inline'* and building blocks approach makes product pages
...
incore's upselling algorythm allows you to show visitors similar but more
...
Get a clear visibility of your sales funnel. incore's Google Analytics trackers
are configured by default to track all kind of events related to shopping
carts, call-to-actions, etc.

As incore marketing tools (mass mailing, campaigns, etc) are also linked with
Google Analytics, you get a complete view of your business.

Target New Markets
------------------

Get your website translated in multiple languages with no effort. incore proposes
...
SEO tools are ready to use, with no configuration required. incore suggests
...
Create new landing pages easily with the incore inline edition feature. Send
...
Benefit from the power of incore, in your online store: a powerfull tax engine,
...
Everything is integrated with incore. No pain, real time.
