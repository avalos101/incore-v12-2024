incore.define('partner_autocomplete.tests', function (require) {
    "use strict";
    ...
    QUnit.module('partner_autocomplete', {
        before: function () {
            var suggestions = [
                {name: "inCore", website: "incore.co", domain: "incore.co", logo: "incore.co/logo.png", vat: "BE0477472701"}
            ];
            ...
            testUtils.patch(AutocompleteCore, {
                ...
                _getinCoreSuggestions(value, isVAT) {
                ...
                _getClearbitSuggestions(value) {
                    return this._getinCoreSuggestions(value);
                },
            });
    ...
    QUnit.test("Partner autocomplete : Company type = Individual", function (assert) {
        ...
        createView({
            ...
            $input.val("incore").trigger("input");
        ...
        createView({
            ...
            mockRPC: function (route, args) {
                ...
                if (route === "/web/static/src/img/placeholder.png"
                    || route === "incore.co/logo.png"
                    || route === "data:image/png;base64,incorebase64") { // land here as it is not valid base64 content
                    return $.when();
                }
            ...
            assert.strictEqual($input.val(), "inCore", "Input value should have been updated to \"inCore\"");
            assert.strictEqual(form.$("input.o_field_widget").val(), "incore.co", "website value should have been updated to \"incore.co\"");
            ...
            $input.val("incore").trigger("input");
            $dropdown = form.$(".o_field_partner_autocomplete .dropdown-menu:visible");
            assert.strictEqual($dropdown.length, 1, "there should be an opened dropdown when typing incore letters again");
