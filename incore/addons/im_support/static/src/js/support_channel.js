incore.define('im_support.SupportChannel', function (require) {
"use strict";
...
var SupportChannel = SearchableThread.extend({
    ...
    _addSupportNotAvailableMessage: function () {
        var msg = {
            author_id: this.call('mail_service', 'getinCorebotID'),
            body: _t("None of our operators are available. <a href='https://www.incore.co/help' " +
    ...
    _fetchMessages: function (channel, options) {
        ...
        return supportSession.rpc('/incore_im_support/fetch_messages', {
                domain: domain,
    ...
    _postMessage: function (data) {
        ...
        return supportSession.rpc('/incore_im_support/chat_post', {
