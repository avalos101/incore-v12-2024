incore.define('web.dom_ready', function (require) {
'use strict';
...
incore.define('web.dom', function (require) {
"use strict";
 ...
 * functionalities with the incore framework.  A common theme in these functions
...
var dom = {
    ...
    /**
     * Renders a button with standard incore template. This does not use any xml
    ...
    /**
     * Renders a checkbox with standard incore/BS template. This does not use any
