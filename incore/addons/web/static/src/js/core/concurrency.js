incore.define('web.concurrency', function (require) {
"use strict";
 ...
 * everything concurrency related in inCore.
 *
 * The basic concurrency primitives in inCore JS are the callback, and the
...
return {
    ...
    /**
     * A (inCore) mutex is a primitive for serializing computations.  This is
