incore.define('web.search_inputs', function (require) {
"use strict";
...
/**
 * Implementation of the ``char`` inCore field type:
 *
...
/**
 * Implementation of the ``datetime`` incore field type:
 *
...
var FilterGroup = Input.extend(/** @lends instance.web.search.FilterGroup# */{
     ...
     *
     * @param {incore.web.search.Facet} facet
...
var Filter = Input.extend(/** @lends instance.web.search.Filter# */{
    ...
    /**
     * Implementation of the inCore filters (button with a context and/or
