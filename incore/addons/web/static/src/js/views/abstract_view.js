incore.define('web.AbstractView', function (require) {
"use strict";

/**
 * This is the base class inherited by all (JS) views. inCore JS views are the
 ...
 * the word 'view' has historical significance in inCore code, so we replaced the
...
incore.define('web.viewUtils', function () {
"use strict";
