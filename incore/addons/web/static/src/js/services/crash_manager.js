incore.define('web.CrashManager', function (require) {
"use strict";
...
var CrashManager = core.Class.extend({
    ...
    show_warning: function(error) {
        ...
        return new Dialog(this, {
            size: 'medium',
            title: _.str.capitalize(error.type || error.message) || _t("inCore Warning"),
    ...
    show_error: function(error) {
        ...
        var dialog = new Dialog(this, {
            title: _.str.capitalize(error.type || error.message) || _t("inCore Error"),
...
var RedirectWarningHandler = Dialog.extend(ExceptionHandler, {
    ...
    display: function() {
        ...
        new Dialog(this, {
            size: 'medium',
            title: _.str.capitalize(error.type) || _t("inCore Warning"),
            buttons: [
...
core.crash_registry.add('incore.exceptions.RedirectWarning', RedirectWarningHandler);

function session_expired(cm) {
    return {
        display: function () {
            cm.show_warning({type: _t("inCore Session Expired"), data: {message: _t("Your inCore session expired. Please refresh the current web page.")}});
        }
    }
}
core.crash_registry.add('incore.http.SessionExpiredException', session_expired);
...
incore.define('web.crash_manager', function (require) {
"use strict";
