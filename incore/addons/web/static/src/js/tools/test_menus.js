(function (exports) {
    ...
    function createWebClientHooks() {
        var AbstractController = incore.__DEBUG__.services['web.AbstractController'];
        var Discuss = incore.__DEBUG__.services['mail.Discuss'];
        var WebClient = incore.__DEBUG__.services["web.WebClient"];
