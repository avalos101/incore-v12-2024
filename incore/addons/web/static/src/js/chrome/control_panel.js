incore.define('web.ControlPanelMixin', function (require) {
"use strict";
...
incore.define('web.ControlPanel', function (require) {
"use strict";
...
var ControlPanel = Widget.extend({
     ...
     * @param {incore.web.SearchView} [status.searchview] the searchview widget
