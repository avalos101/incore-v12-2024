incore.define('web.ActionManager', function (require) {
"use strict";
 ...
 * Its role is to makes sure that inCore actions are properly started and
 * coordinated.
 */
...
var ActionManager = Widget.extend({
    ...
    /**
     * This is the entry point to execute inCore actions, given as an ID in
     ...
     * @param {inCoreEvent} ev.data.controllerID
     */
