incore.define('web.AbstractWebClient', function (require) {
"use strict";
...
var AbstractWebClient = Widget.extend(ServiceProviderMixin, KeyboardNavigationMixin, {
    ...
    init: function (parent) {
        // a flag to determine that incore is fully loaded
        incore.isReady = false;
        this.client_options = {};
        this._super(parent);
        ...
        this.set('title_part', {"zincore": "inCore"});
    },
    start: function () {
        var self = this;
