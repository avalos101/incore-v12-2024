...
from incore.tools import mute_logger, float_repr, pycompat
from incore.tools.date_utils import add, subtract, start_of, end_of
...
class TestFields(common.TransactionCase):
    ...
    def test_90_binary_svg(self):
        from incore.addons.base.tests.test_mimetypes import SVG
