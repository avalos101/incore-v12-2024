...
from incore import api, http, SUPERUSER_ID, _
from incore.exceptions import AccessDenied
from incore.http import request
from incore import registry as registry_get

from incore.addons.auth_signup.controllers.main import AuthSignupHome as Home
from incore.addons.web.controllers.main import db_monodb, ensure_db, set_cookie_and_redirect, login_and_redirect
...
class OAuthController(http.Controller):
    ...
    def oea(self, **kw):
        """login user via inCore Account provider"""
        ...
        with registry.cursor() as cr:
            try:
                ...
                provider = env.ref('auth_oauth.provider_incore')
            except ValueError:
