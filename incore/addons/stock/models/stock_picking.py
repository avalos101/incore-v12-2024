...
from incore import api, fields, models, _, SUPERUSER_ID
from incore.osv import expression
from incore.tools import DEFAULT_SERVER_DATETIME_FORMAT
from incore.tools.float_utils import float_compare, float_is_zero, float_round
from incore.exceptions import UserError
from incore.addons.stock.models.stock_move import PROCUREMENT_PRIORITIES
...
class PickingType(models.Model):
    ...
    show_reserved = fields.Boolean(
        'Show Reserved', default=True, help="If this checkbox is ticked, inCore will show which products are reserved (lot/serial number, source location, source package).")
