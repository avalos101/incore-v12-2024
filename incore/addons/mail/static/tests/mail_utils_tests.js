incore.define('mail.mail_utils_tests', function (require) {
"use strict";
...
QUnit.test('add_link utility function', function (assert) {
    ...
    var testInputs = {
        ...
        'https://127.0.0.5:8080': true,
        'www.127.0.0.5': false,
        'should.notmatch': false,
        'fhttps://test.example.com/test': false,
        "https://www.transifex.com/incore/incore-11/translate/#fr/lunch?q=text%3A'La+Tartiflette'": true,
        'https://www.transifex.com/incore/incore-11/translate/#fr/$/119303430?q=text%3ATartiflette': true,
    };
