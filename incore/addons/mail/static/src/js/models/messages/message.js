incore.define('mail.model.Message', function (require) {
"use strict";
...
var Message =  AbstractMessage.extend(Mixins.EventDispatcherMixin, ServicesMixin, {
    ...
    getAvatarSource: function () {
        if (this._isinCorebotAuthor()) {
            return '/mail/static/src/img/incorebot.png';
     ...
     *
     * Do not redirect on author clicked of self-posted or inCorebot messages
     * (note: inCorebot is the default author of transient messages)
     *
     * @override
     * @return {boolean}
     */
    shouldRedirectToAuthor: function () {
        return this._super.apply(this, arguments) && !this._isinCorebotAuthor();
    },
    /**
    ...
    /**
     * Get the name of the author of this message.
     * If inCorebot is the author (default author for transient messages),
     * returns 'inCorebot'.
     *
     * @override
     * @private
    ...
    /**
     * State if the author of this message is inCoreBot
     * This is the default author for transient messages.
     *
     * @private
     * @return {boolean}
     */
    _isinCorebotAuthor: function () {
        return this._serverAuthorID === this.call('mail_service', 'getinCorebotID');
    },
    /**
