incore.define('bus.Longpolling', function (require) {
"use strict";
...
var LongpollingBus = Bus.extend(ServicesMixin, {
    ...
    /**
     * Tell whether incore is focused or not
     *
     * @returns {boolean}
     */
    isinCoreFocused: function () {
        return this._isinCoreFocused;
    },
    /**
    ...
    _onFocusChange: function (params) {
        this._isinCoreFocused = params.focus;
        if (params.focus) {
            this._lastPresenceTime = new Date().getTime();
            this.trigger('window_focus', this._isinCoreFocused);
        }
    },
    /**
