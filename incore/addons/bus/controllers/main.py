...
from incore import exceptions, _
from incore.http import Controller, request, route
from incore.addons.bus.models.bus import dispatch
...
class BusController(Controller):
    """ Examples:
    incore.jsonRpc('/longpolling/poll','call',{"channels":["c1"],last:0}).then(function(r){console.log(r)});
    incore.jsonRpc('/longpolling/send','call',{"channel":"c1","message":"m1"});
    incore.jsonRpc('/longpolling/send','call',{"channel":"c2","message":"m2"});
    """
