...
To: {to}
cc: {cc}
Received: by mail1.incore.co (Postfix, from userid 10002)
...
Received: from mail-ie0-f173.google.com (mail-ie0-f173.google.com [209.85.223.173])
    ...
    for <raoul@incore.fr>; Fri, 23 Aug 2013 13:17:55 +0200 (CEST)
...
From: Anon <anon@incore.co>
To: anon@gmail.com
References: <f3b9f8f8-28fa-2543-cab2-7aa68f679ebb@incore.co>
Message-ID: <cb7eaf62-58dc-2017-148c-305d0c78892f@incore.co>
Date: Wed, 14 Mar 2018 14:26:58 +0100
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:52.0) Gecko/20100101
 Thunderbird/52.6.0
MIME-Version: 1.0
In-Reply-To: <f3b9f8f8-28fa-2543-cab2-7aa68f679ebb@incore.co>
Content-Type: multipart/mixed;
...
Delivered-To: anon2@gmail1.incore.co
...
ARC-Authentication-Results: i=1; mx.google.com;
       dkim=pass header.i=@incore.co header.s=mail header.b=MCzhjB9b;
       spf=pass (google.com: domain of soup@incore.co designates 149.202.180.44 as permitted sender) smtp.mailfrom=soup@incore.co;
       dmarc=pass (p=NONE sp=NONE dis=NONE) header.from=incore.co
Return-Path: <soup@incore.co>
Received: from mail2.incore.co (mail2.incore.co. [149.202.180.44])
        by mx.google.com with ESMTPS id y4si4279200wmy.148.2018.03.05.01.19.22
        (version=TLS1_2 cipher=ECDHE-RSA-AES128-GCM-SHA256 bits=128/128);
        Mon, 05 Mar 2018 01:19:23 -0800 (PST)
Received-SPF: pass (google.com: domain of soup@incore.co designates 149.202.180.44 as permitted sender) client-ip=149.202.180.44;
...
Received: from [10.10.31.24] (unknown [91.183.114.50])
	...
	by mail2.incore.co (Postfix) with ESMTPSA id 7B571A4085
	for <what@incore.co>; Mon,  5 Mar 2018 10:19:21 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple; d=incore.co; s=mail;
...
To: what@incore.co
From: Soup <soup@incore.co>
Subject: =?UTF-8?Q?Soupe_du_jour_:_Pois_cass=c3=a9s?=
Message-ID: <a05d8334-7b7c-df68-c96a-4a88ed19f31b@incore.co>
...
X-Spam-Checker-Version: SpamAssassin 3.4.0 (2014-02-07) on mail2.incore.co
...
Chaussée de Namur, 40
B-1367 Grand Rosière
Web: <a class="moz-txt-link-freetext" href="http://www.incore.co">http://www.incore.co</a> </pre>
  </body>
</html>
...
In-Reply-To: <829228111124527.1111111602.256611118262939-incore-129-xxxx.xxxx@ip-1-1-1-1>
References: <867911111953277.1523671337.187951111160400-incore-129-xxxx.xxxx@ip-1-1-1-1>
 <867911111953277.1523671337.256611118262939-incore-129-xxxx.xxxx@ip-1-1-1-1>
...
.256660938262939-incore-129-xxxx.xxxx@ip-1-1-1-1" type=3D"cite"=
 class=3D"cite2">
...
"0" bgcolor=3D"#03A9F4" style=3D"min-width: 590px; background-color: rgb(13=
...
.com" style=3D"text-decoration:none; color: white;">
                      ...
                      <tr>
                        <td align=3D"center">
                            Powered by <a href=3D"https://www.incore.co">Odo=
o</a>.
                        </td>
                      </tr>
                    </tbody>
