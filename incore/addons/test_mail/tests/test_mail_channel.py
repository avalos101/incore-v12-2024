...
from incore.exceptions import AccessError, except_orm, ValidationError, UserError
...
class TestChannelAccessRights(common.BaseFunctionalTest, common.MockEmails):
    ...
    @mute_logger('incore.addons.base.models.ir_model', 'incore.models', 'incore.models.unlink')
...
class TestChannelFeatures(common.BaseFunctionalTest, common.MockEmails):
    ...
    @mute_logger('incore.addons.mail.models.mail_mail', 'incore.models.unlink')
...
class TestChannelModeration(common.Moderation):
    ...
    @mute_logger('incore.addons.mail.models.mail_channel', 'incore.models.unlink')
    ...
    @mute_logger('incore.models.unlink')
