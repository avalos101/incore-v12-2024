...
from incore.addons.test_mass_mailing.tests.common import MassMailingCase
from incore.addons.base.models.ir_config_parameter import IrConfigParameter
from incore.tests.common import TransactionCase, users
