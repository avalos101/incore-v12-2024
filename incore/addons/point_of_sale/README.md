incore Point of Sale
-----------------------------

incore's <a href="https://www.incore.com/page/point-of-sale">Point of Sale</a>
...
incore's POS is a web application that can run on any device that can display
...
### incore's POS stays reliable even if your connection isn't
...
Say goodbye to ugly, outdated POS software and enjoy the incore web interface
...
time and use incore's powerful reporting to make smarter decisions to improve
...
With incore as a backend, you have a system proven to be perfectly suitable for
...
With incore, you get a 360° customer view, including cross-channel sales,
