...
REPO=https://github.com/incore/incore.git
...
CLONE_DIR="${OVERWRITE_FILES_BEFORE_INIT_DIR}/home/pi/incore"
...
incore/
incore-bin" | tee --append .git/info/sparse-checkout > /dev/null
