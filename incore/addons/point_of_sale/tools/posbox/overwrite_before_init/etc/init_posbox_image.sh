...
mkdir -v /var/log/incore
chown pi:pi /var/log/incore
chown pi:pi -R /home/pi/incore/
...
echo "* * * * * rm /var/run/incore/sessions/*" | crontab -
...
echo "addons/hw_drivers/drivers/" > /home/pi/incore/.git/info/exclude
