incore.define('web_editor.iframe', function (require) {
'use strict';
...
window.top.incore[callback + '_updown'] = function (value, fields_values, field_name) {
...
editor.Class.include({
    start: function () {
        this.on('rte:start', this, function () {
            ...
            if (window.top.incore[callback + '_editor']) {
                window.top.incore[callback + '_editor'](this);
            }
            ...
            $editable.on('content_changed', this, function () {
                if (window.top.incore[callback + '_downup']) {
                    window.top.incore[callback + '_downup']($editable.prop('innerHTML'));
                }
            });
        });
...
incore.define('root.widget', function (require) {
'use strict';
...
incore.define('web_editor.IframeRoot', function (require) {
'use strict';
