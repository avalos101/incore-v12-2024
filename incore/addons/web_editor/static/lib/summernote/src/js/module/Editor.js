define([
  ...
  var Editor = function (handler) {
    ...
    this.style = style;   // INCORE: allow access for override
    this.table = table;   // INCORE: allow access for override
    this.typing = typing; // INCORE: allow access for override
    this.bullet = bullet; // INCORE: allow access for override
    ...
    this.saveRange = function ($editable, thenCollapse) {
      // INCORE: scroll to top when click on input in editable m (start_modification
      // this.focus($editable);
      var r = range.create();
      if (!r || ($editable[0] !== r.sc && !$.contains($editable[0], r.sc))) {
        $editable.focus();
      }
      // INCORE: end_modication)
    ...
    this.createLink = function ($editable, linkInfo, options) {
      ...
      var anchors = [];
      // INCORE: adding this branch to modify existing anchor if it fully contains the range
      ...
      $.each(anchors, function (idx, anchor) {
        ...
        $(anchor).attr('class', linkInfo.className || null); // INCORE: addition
        $(anchor).css(linkInfo.style || {}); // INCORE: addition
        if (isNewWindow) {
