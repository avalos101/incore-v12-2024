...
Also, adds methods to convert values back to inCore models.
"""
...
from incore.tools import html_escape as escape
from incore.addons.base.models import ir_qweb
...
class Image(models.AbstractModel):
    ...
    def load_local_url(self, url):
        ...
        path = incore.modules.get_module_resource(
