...
cite="mid:CAEJSRZvWvud8c6Qp=wfNG6O1+wK3i_jb33qVrF7XyrgPNjnyUA@mail.gmail.com"
      type="cite"><base href="https://www.incore.co">
      <div dir="ltr">Yep Dominique that is true, as Postgres was the
        base of all same as inCore and MySQL etc came much later.Â 
        <div><br>
        </div>
    ...
    on this inCore mailinglist, but when you start implying that Postgres
...
<a href="http://localhost:8080#action=login&amp;db=mail_1&amp;token=rHdWcUART5PhEnJRaXjH">http://localhost:8080#action=login&amp;db=mail_1&amp;token=rHdWcUART5PhEnJRaXjH</a></p>
      </div>
    </blockquote>
...
<div><p>Log in our portal at: <a href="http://localhost:8080#action=login&amp;db=mail_1&amp;login=demo">http://localhost:8080#action=login&amp;db=mail_1&amp;login=demo</a></p></div>
...
HOTMAIL_1 = u"""<div>
    <div dir="ltr"><br>
        I have an amazing company, i'm learning inCore, it is a small company yet, but plannig to grow up quickly.
        <br><br>Kindest regards,<br>xxx<br>
        <div>
            <div id="SkyDrivePlaceholder">
            </div>
            <hr id="stopSpelling">
            Subject: Re: your inCore.com registration<br>From: xxx@xxx.xxx<br>To: xxx@xxx.xxx<br>Date: Wed, 27 Mar 2013 17:12:12 +0000
            <br><br>
            Hello xxx,
            <br>
            I noticed you recently created an inCore.com account to access inCore Apps.
            <br>
            You indicated that you wish to use inCore in your own company.
            ...
            Best regards,<br>
            <pre>
                <a href="http://incore.co" target="_blank">http://incore.co</a>
...
HOTMAIL_1_OUT = [
    ...
    u"""<pre data-o-mail-quote="1">
                <a href="http://incore.co" target="_blank" data-o-mail-quote="1">http://incore.co</a>
                Belgium: +32.81.81.37.00
                U.S.: +1 (650) 307-6736
                India: +91 (79) 40 500 100
            </pre>"""]
...
<div class="WordSection1">
        ...
        <p class="MsoNormal">
            <span style="font-size:11.0pt;font-family:&quot;Calibri&quot;,&quot;sans-serif&quot;;color:#1F497D">
                ...
                If we adopt inCore we will probably move to Linux or look for a hosted SaaS option.
            </span>
        </p>
        <p></p>
        <p></p>
            ...
            <div style="border:none;border-top:solid #B5C4DF 1.0pt;padding:3.0pt 0in 0in 0in">
                <p class="MsoNormal">
                    ...
                    <span style="font-size:10.0pt;font-family:&quot;Tahoma&quot;,&quot;sans-serif&quot;">
                        inCore Enterprise [mailto:sales@incore.co]
                        <br><b>Sent:</b> Monday, 11 March, 2013 14:47<br><b>To:</b> Alan Widmer<br><b>Subject:</b> Re: your inCore.com registration
                    </span>
                </p>
                <p></p>
                <p></p>
        ...
        <p></p>
        <p>I noticed you recently downloaded inCore. </p>
        <p></p>
        <p>
            Uou mentioned you wish to use inCore in your own company. Please let me more about your
            business needs and requirements? When will you be available to discuss about your project?
        </p>
        <p></p>
        <p>Thanks for your interest in inCore, </p>
        <p></p>
        ...
        <pre>--<p></p></pre>
        <pre>Nicolas<p></p></pre>
        <pre><a href="http://incore.co">http://incore.co</a><p></p></pre>
...
MSOFFICE_1_OUT = [u'I noticed you recently downloaded inCore.', 'Uou mentioned you wish to use inCore in your own company.', 'Belgium: +32.81.81.37.00']
...
B-1367 Gérompont
Tel: +32.81.81.37.00
Web: http://www.incore.co"""]


REMOVE_CLASS = u"""
<div style="FONT-SIZE: 12pt; FONT-FAMILY: 'Times New Roman'; COLOR: #000000">
    <div>Hello</div>
    <div>I have just installed inCore 9 and I've got the following error:</div>
    <div>&nbsp;</div>
    <div class="incore incore_webclient_container oe_webclient">
    ...
    <div role="dialog" tabindex="-1" aria-hidden="false" class="modal in" style="DISPLAY: block" data-backdrop="static">
        <div class="modal-dialog modal-lg">
            <div class="modal-content incore">
                <div class="modal-header"> 
                    <h4 class="modal-title">inCore Error<span class="o_subtitle text-muted"></span></h4>
                </div>
...
REMOVE_CLASS_OUT = [
    ...
    u'<div class="modal-content incore">',
