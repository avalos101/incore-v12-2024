...
class TestExpression(TransactionCase):
    ...
    def test_10_hierarchy_in_m2m(self):
        ...
        with self.assertLogs('incore.osv.expression'):
    ...
    def test_15_m2o(self):
        ...
        # that don't have inCore has a parent company, you expect to find,
    ...
    def test_active(self):
        ...
        vals = {
            ...
            'child_ids': [(0, 0, {'name': 'address of inCore Test', 'country_id': self.ref("base.be")})],
        }
        Partner.create(vals)
