...
from incore import api, fields, models, tools, SUPERUSER_ID, exceptions, _
from incore.exceptions import AccessError, ValidationError
from incore.tools import config, human_size, ustr, html_escape
from incore.tools.mimetypes import guess_mimetype
from incore.tools import crop_image, image_resize_image
...
class IrAttachment(models.Model):
    """Attachments are used to link binary files or url to any incore document.
