...
import incore
from incore import api, http, models, tools, SUPERUSER_ID
from incore.exceptions import AccessDenied, AccessError
from incore.http import request, STATIC_CACHE, content_disposition
from incore.tools import pycompat, consteq
from incore.tools.mimetypes import guess_mimetype
from ast import literal_eval
from incore.modules.module import get_resource_path, get_module_path
...
class IrHttp(models.AbstractModel):
    ...
    def routing_map(cls):
        if not hasattr(cls, '_routing_map'):
            ...
            if tools.config['test_enable'] and incore.modules.module.current_test:
                installed.add(incore.modules.module.current_test)
            mods = [''] + incore.conf.server_wide_modules + sorted(installed)
