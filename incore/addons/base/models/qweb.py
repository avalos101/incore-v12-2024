...
from incore.tools import pycompat, freehash
...
class QWeb(object):
    ...
    def _base_module(self):
        ...
        * string_types (replacement for basestring)
        ...
        return ast.parse(dedent("""
            ...
            from incore.tools.pycompat import to_text, string_types
            from incore.addons.base.models.qweb import escape, foreach_iterator
            """))
    ...
    def _compile_directive_field(self, el, options):
        """ Compile something like ``<span t-field="record.phone">+1 555 555 8080</span>`` """
        node_name = el.tag
