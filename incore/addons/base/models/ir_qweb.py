...
from incore import api, models, tools
from incore.tools.safe_eval import assert_valid_codeobj, _BUILTINS, _SAFE_OPCODES
from incore.http import request
from incore.modules.module import get_resource_path

from incore.addons.base.models.qweb import QWeb, Contextifier
from incore.addons.base.models.assetsbundle import AssetsBundle
    ...
    * to customize ``t-field`` rendering, subclass ``ir.qweb.field`` and
    ...
    def _get_asset_content(self, xmlid, options):
        ...
        def get_modules_order():
            if request:
                from incore.addons.web.controllers.main import module_boot
