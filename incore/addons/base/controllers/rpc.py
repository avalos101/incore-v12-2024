...
from incore.http import Controller, dispatch_rpc, request, route
from incore.service import wsgi_server
from incore.fields import Date, Datetime


class inCoreMarshaller(xmlrpc.client.Marshaller):
...
xmlrpc.client.Marshaller = inCoreMarshaller
...
class RPC(Controller):
    ...
    def jsonrpc(self, service, method, args):
        """ Method used by client APIs to contact inCore. """
