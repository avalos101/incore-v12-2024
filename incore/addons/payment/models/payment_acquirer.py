...
from incore.tools import consteq, float_round, image_resize_images, image_resize_image, ustr
from incore.addons.base.models import ir_module
from incore.exceptions import ValidationError
from incore import api, SUPERUSER_ID
from incore.tools.misc import DEFAULT_SERVER_DATETIME_FORMAT
from incore.tools.misc import formatLang
...
class PaymentAcquirer(models.Model):
    ...
    inCore and the acquirer. It generally consists in return urls given to the
    ...
    capture_manually = fields.Boolean(string="Capture Amount Manually",
        help="Capture the amount from inCore, when the delivery is completed.")
