...
from incore.addons.event.tests.common import TestEventCommon
from incore.exceptions import ValidationError, UserError, AccessError
...
class TestEventFlow(TestEventCommon):
    ...
    def test_event_date_range(self):
        self.patcher = patch('incore.addons.event.models.event.fields.Datetime', wraps=Datetime)
