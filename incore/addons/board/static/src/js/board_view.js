incore.define('board.BoardView', function (require) {
"use strict";
    ...
    _createController: function (params) {
        ...
        return this._rpc({
            ...
            .then(function (action) {
                ...
                // override the https://github.com/incore/incore/pull/28408language to take the current one
...
incore.define('board.viewRegistry', function (require) {
"use strict";
