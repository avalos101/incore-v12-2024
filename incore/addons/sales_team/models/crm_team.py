...
from incore.release import version
from incore.tools import DEFAULT_SERVER_DATE_FORMAT as DF
...
class CrmTeam(models.Model):
    ...
    reply_to = fields.Char(string='Reply-To',
                           help="The email address put in the 'Reply-To' of all emails sent by incore about cases in this Sales Team")
