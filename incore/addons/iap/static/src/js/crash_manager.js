incore.define('iap.CrashManager', function (require) {
"use strict";
...
CrashManager.include({
    ...
    _getButtonMessage: function (isTrial){
        var isEnterprise = _.last(incore.session_info.server_version_info) === 'e';
        return isTrial && isEnterprise ? _t('Start a Trial at inCore') : _t('Buy credits at inCore');
    },
    /**
     * @override
     */
    rpc_error: function (error) {
        var self = this;
        if (error.data.name === "incore.addons.iap.models.iap.InsufficientCreditError") {
            ...
            ajax.jsonRpc('/web/dataset/call_kw', 'call', {
                ...
                var content = $(QWeb.render('iap.redirect_to_incore_credit', {
                        data: error_data,
                    }));
                if (error_data.body) {
