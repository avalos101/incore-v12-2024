function initialize_map() {
    ...
    var map = new google.maps.Map(document.getElementById('incore-google-map'), {
        zoom: 1,
    ...
    if (incore_partner_data){ /* incore_partner_data special variable should have been defined in google_map.xml */
        for (var i = 0; i < incore_partner_data.counter; i++) {
            set_marker(incore_partner_data.partners[i]);
        }
