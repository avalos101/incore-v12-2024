...
from incore.tools import email_re, email_split, email_escape_char, float_is_zero, float_compare, \
    pycompat, date_utils
...
class AccountInvoice(models.Model):
    ...
    def message_new(self, msg_dict, custom_values=None):
        ...
        # 2) otherwise, if the email sender is from incore internal users then it is likely that the vendor sent the bill
