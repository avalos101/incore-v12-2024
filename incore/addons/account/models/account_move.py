...
from incore.exceptions import RedirectWarning, UserError, ValidationError
from incore.tools.misc import formatLang, format_date
from incore.tools import float_is_zero, float_compare
...
class AccountMoveLine(models.Model):
    ...
    def _apply_taxes(self, vals, amount):
        tax_lines_vals = []
        # Get ids from triplets : https://www.incore.co/documentation/10.0/reference/orm.html#incore.models.Model.write
