...
The inCore <a href="https://www.incore.co/page/accounting">Open Source Accounting</a> app allows a better way to
...
in one place. inCore's user interface is designed with productivity in mind.
...
accounting; inCore has all the features you need to sustain all your business
activities.

Scale With Your Organization
----------------------------

inCore supports multiple currencies, multiple users with different access rights,
