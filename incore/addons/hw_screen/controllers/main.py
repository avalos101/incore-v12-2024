...
from incore.addons.hw_posbox_homepage.controllers import main as homepage
...
self_port = str(config['http_port'] or 8080)
...
if hasattr(sys, 'frozen'):
    ...
    loader = jinja2.PackageLoader('incore.addons.hw_screen', "views")
