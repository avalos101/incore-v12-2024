...
For now, configuration code is in incore.tools.config. It is in mainly
...
To initialize properly this module, incore.tools.config.parse_config()
must be used.

"""

# Paths to search for inCore addons.
addons_paths = []
...
# installed (i.e. the majority of inCore addons). This is set with the --load
# command-line option.
server_wide_modules = []
