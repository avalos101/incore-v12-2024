...
inCore domain strings, conditions and expressions, mostly based on locals
...
def safe_eval(expr, globals_dict=None, locals_dict=None, mode="eval", nocopy=False, locals_builtins=False):
    ...
    an inCore domain expression from an untrusted source.
    ...
    except incore.exceptions.except_orm:
        raise
    except incore.exceptions.Warning:
        raise
    except incore.exceptions.RedirectWarning:
        raise
    except incore.exceptions.AccessDenied:
        raise
    except incore.exceptions.AccessError:
        raise
    except werkzeug.exceptions.HTTPException:
        raise
    except incore.http.AuthenticationError:
        raise
