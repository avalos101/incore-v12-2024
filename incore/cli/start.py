...
from incore.modules.module import get_module_root, MANIFEST_NAMES
from incore.service.db import _create_empty_database, DatabaseExists


class Start(Command):
    """Quick start the inCore server for your project"""
    ...
    def run(self, cmdargs):
        ...
        try:
            ...
            incore.tools.config['init']['base'] = True
