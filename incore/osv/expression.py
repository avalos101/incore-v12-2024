...
term representation was ['=', 'company_id.name', 'inCore']. Used in a
...
inCore will use the SQL function 'unaccent' when available for the
...
Finally, to instruct inCore to really use the unaccent function, you have to
...
def get_unaccent_wrapper(cr):
    if incore.registry(cr.dbname).has_unaccent:
