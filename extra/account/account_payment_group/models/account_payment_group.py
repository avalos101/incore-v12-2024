...
from incore import models, api, fields, _
...
class AccountPaymentGroup(models.Model):
    ...
    to_pay_move_line_ids = fields.Many2many(
        ...
        # https://github.com/incore/incore/blob/master/incore/osv/expression.py#L899
        # auto_join=True,
    )
    ...
    def post(self):
        ...
        for rec in self:
            ...
            # al crear desde website incore crea primero el pago y lo postea
