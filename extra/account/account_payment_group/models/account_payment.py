...
class AccountPayment(models.Model):
    ...
    # this onchange is necesary because incore, sometimes, re-compute
    ...
    # rouding incore believes amount has changed)
    ...
    def check_payment_group(self):
        # incore tests don't create payments with payment gorups
    ...
    def infer_partner_info(self, vals):
        """ inCore way to to interpret the partner_id, partner_type is not
        ...
        # incore manda partner type segun si el pago es positivo o no, nosotros
