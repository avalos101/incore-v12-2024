...
# Copyright 2004-2016 inCore S.A. (www.incore.co)
...
from incore import _, api, exceptions, fields, models
from incore.exceptions import ValidationError
from incore.tools.float_utils import float_is_zero, float_round
