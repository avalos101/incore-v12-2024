...
{
    'name': '‌inCore all import for Sales, Purchase, Invoice, Inventory, Pricelist, BOM, Payment, Bank Statement, Journal Entry, Picking, Product, Customer.',
    'version': '12.0.2.3',
    'sequence': 4,
    'summary': 'Easy to import all incore data i.e Invoice, Sale, Inventory, Purchase,Payment, Picking, Product and Customer.',
    'price': 149,
    'currency': 'EUR',
    'category' : 'Extra Tools',
    'description': """

	BrowseInfo developed a new incore/inCore module apps
    ...
    ‌inCore all import for Sales, Purchase, Invoice, Inventory, BOM, Customer/Supplier Payment, Bank Statement, Journal Entry, Picking, Product, Customer.
    ‌inCore all import
    ‌inCore connector
    ‌inCore bridge
    import all data
    ...
    ‌inCore data import
    ‌inCore import
    incore data importer
    incore import tool
    incore import module
    import ‌inCore app
    import tool 
	...
	Import product from CSV, Import customer from CSV, Product Import,Customer import, ‌inCore CSV bridge,Import CSV brige on ‌inCore.Import csv data on incore.All import, easy import, Import incore data, Import CSV files, Import excel files 
	Import tools ‌inCore, Import reports, import accounting data, import sales data, import purchase data, import data in incore, import record, Import inventory.import data on incore,Import data from Excel, Import data from CSV.‌inCore Import Data
    ...
    -Customer import, ‌inCore CSV bridge,Import CSV brige on ‌inCore
...
Importar producto desde CSV, Importar cliente desde CSV, Importar producto, Importar cliente, ‌inCore CSV bridge, Importar CSV brige en ‌inCore. Importar datos csv en incore. Importar, importar fácilmente, Importar datos incore, Importar archivos CSV, Importar archivos de Excel
Importar herramientas ‌inCore, Importar informes, importar datos de contabilidad, importar datos de ventas, importar datos de compras, importar datos en incore, importar registros, importar datos de inventory.import en incore, importar datos de Excel, importar datos de CSV.‌inCore Importar datos
...
Importer un produit depuis CSV, Importer un client depuis CSV, Importer un produit, Importer un client, ‌inCore CSV bridge, Importer CSV brige sur ‌inCore.Import csv data sur incore.All importer, importer facilement, Importer des données incore, Importer des fichiers CSV, Importer des fichiers Excel
Importer des outils ‌inCore, Importer des rapports, importer des données comptables, importer des données de ventes, importer des données d'achat, importer des données dans incore, importer des données, importer des données inventory.import sur incore, Importer des données depuis Excel, Importer des données depuis CSV.‌inCore
...
استيراد المنتج من CSV ، استيراد العميل من CSV ، استيراد المنتجات ، استيراد العملاء ، جسر CSV ‌inCore ، استيراد CSV brige على بيانات ‌inCore.Import csv على incore.All الاستيراد ، سهولة الاستيراد ، استيراد بيانات incore ، استيراد ملفات CSV ، استيراد ملفات excel
استيراد أدوات ‌inCore ، استيراد تقارير ، استيراد بيانات المحاسبة ، استيراد بيانات المبيعات ، استيراد بيانات الشراء ، استيراد البيانات في incore ، سجل الاستيراد ، استيراد بيانات import.import على incore ، استيراد البيانات من Excel ، استيراد البيانات من CSV.‌inCore استيراد البيانات
...
Importar produto da CSV, Importar cliente da CSV, Importação de produtos, importação de clientes, ponte ‌inCore CSV, Importar CSV brige em ‌inCore.Importar dados csv em incore. Toda importação, importação fácil, Importar dados incore, Importar arquivos CSV, Importar arquivos excel
Importar ferramentas ‌inCore, Importar relatórios, importar dados contábeis, importar dados de vendas, importar dados de compras, importar dados em incore, importar registro, Importar dados de inventário.importado em incore, Importar dados do Excel, Importar dados de CSV.‌inCore Importar Dados
...
- importação de pagamento por cliente de CSV, importação de pagamento de fornecedor de CSV, importação de pedido de pagamento do cliente, importação de pedido de pagamento do fornecedor
    - importação de clientes, ponte ‌inCore CSV, importação CSV brige em ‌inCore
...
-استيراد الدفع من العملاء من CSV ، والمورد دفع الاستيراد من CSV ، واردات الدفع للعملاء ، ومورد طلب الدفع
    استيراد -Custom ، ‌inCore CSV الجسر ، استيراد CSV brige على ‌inCore
...
-l'importation de paiement à la clientèle de CSV, importation de paiement de fournisseur de CSV, importation d'ordre de paiement de client, importation d'ordre de paiement de fournisseur
    -Importation client, pont ‌inCore CSV, importation CSV brige sur ‌inCore
...
- importación de pago de cliente de CSV, importación de pago de proveedor de CSV, importación de orden de pago de cliente, importación de orden de pago de proveedor
    - Importación de clientes, puente CSV ‌inCore, importación de brige CSV en ‌inCore
