...
-------------------------
- Whats new? 
  -- Removed DUPLICATE reports since they are no longer part of standard inCore reports.


`Version 0.1 (29 OCT 2018)`
-------------------------
- New module for inCore 12.0 ported from the same module for incore 11.0 with same features and settings
