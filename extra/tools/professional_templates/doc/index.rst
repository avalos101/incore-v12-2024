...
This Module is a standard inCore Module. Once you purchase it, please follow the following steps to install it:

- A download link will be given by inCore once you purchase this module.

- You need to extract the downloaded file into inCore 'addons' directory where all other modules are kept or you can put it anywhere else depending on your inCore Configuration

- It may not be necessary to restart inCore at this stage, but it is highly recommended.
...
- Fully Supports inCore Version 12.0
...
===========================================
 ...
 - How do I print the reports in a different language?
        ...
        First you need to translate the templates into your language. Please learn about how to do translation in inCore here: https://www.incore.com/documentation/10.0/reference/translations.html
 ...
 - The `Header` content is overlapping the `Body` content of the report?
	...
	This is not a big problem since in inCore you can adjust the Paper Sizes to match the size of your logo or Address.

		- If this happens, Enable `Debug Mode` in inCore 9.0 in order to access the Extra `Technical Settings` 
