# -*- coding: utf-8 -*-
{
    ...
    'author': "inCore",
    'website': "http://incore.co",

    # Categories can be used to filter modules in modules listing
    # Check https://github.com/incore/incore/blob/master/incore/addons/base/module/module_data.xml
    # for the full list
    ...
    'data': [
        ...
        'sale_order/incore_template.xml',
        ...
        'purchase_order/incore_template.xml',
        ...
        'delivery_note/incore_template.xml',
