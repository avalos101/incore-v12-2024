...
class ResConfigSettings(models.TransientModel):
    ...
    app_system_name = fields.Char('System Name', help=u"Setup System Name,which replace incore")
    ...
    app_show_share = fields.Boolean('Show Share Dashboard', help=u"Uncheck to hide the incore Share Dashboard")
    app_show_poweredby = fields.Boolean('Show Powered by incore', help=u"Uncheck to hide the Powered by text")
    app_stop_subscribe = fields.Boolean('Stop incore Subscribe(Performance Improve)', help=u"Check to stop incore Subscribe function")
    group_show_author_in_apps = fields.Boolean(string="Show Author in Apps Dashboard", implied_group='app_incore_customize.group_show_author_in_apps',
    ...
    app_account_title = fields.Char('My incore.com Account Title')
    app_account_url = fields.Char('My incore.com Account Url')
    ...
    def get_values(self):
        ...
        app_system_name = ir_config.get_param('app_system_name', default='incoreApp')
