...
from incore.addons.google_drive.models.google_drive import GoogleDrive
from incore.exceptions import Warning
import incore
from incore.http import content_disposition
import pytz
import requests
import logging
        ...
        for rec in conf_ids:
            ...
            if rec.name in db_list:
                ...
                try:
                    ...
                    incore.service.db.dump_db(rec.name, fp, rec.backup_type)
                    fp.close()
