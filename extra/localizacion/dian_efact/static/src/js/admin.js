incore.define('module.DianBackend', function(require) {

    "use strict";
    var mainIntervalTime = 3500;
    var rpc = require('web.rpc');
    var session_info = incore.session_info;
    /**
    ...
    var mainInterval = setInterval(function() {
            $(document).ready(function() {
                ...
                $(document).on("click", ".edit-buttons", function() {
                    var intervalJournalSelect = setInterval(function() {
                        if ($(".hidden_partner_id").length > 0) {

                            var partner_id = $(".hidden_partner_id").val();
                ...
                $(".country_id").on("change",function(){
                    ...
                    alert(country_name)
                    if(country_name="Perú")
                    {
                        populate_peruan_districts();
                    }
            ...
            /**
             * BG FIX: after clicks edit and save main incore button representant table disapear
             */
