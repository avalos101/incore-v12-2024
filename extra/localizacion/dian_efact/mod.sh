#!/bin/bash
#sudo /etc/init.d/incoreRockscripts-server restart
sudo /etc/init.d/incore_diancol-server restart
sudo /etc/init.d/postgresql stop
sudo /etc/init.d/postgresql restart
#sudo mv /home/rockscripts/.local/lib/python3.6/site-packages/xmlsec* /usr/local/lib/python3.6/dist-packages
#sudo /etc/init.d/incore restart
...
#PGPASSWORD=Productoresonline1 psql -U incore -d ecomerce
...
# https://parikshitvaghasiya.blogspot.com/2018/08/change-to-port-80-instead-of-8069-incore.html
