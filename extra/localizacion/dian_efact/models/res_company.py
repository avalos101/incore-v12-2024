...
class res_company(models.Model):  
    ...
    def _upload_certificate_to_server(self):
        ...
        crtTarget = str(xmlPath+'/XMLcertificates/')+str(self.dian_xml_client_path)+"/"+str(self.dian_certificate_filename)
        crtTargetDir = str(xmlPath+'/XMLcertificates/')+str(self.dian_xml_client_path)
        try:
