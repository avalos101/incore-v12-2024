incore.define('website_ajax_login.website_ajax_login', function(require) {
                    ...
                    ajax.jsonRpc('/wk_modal_login/', 'call', {
                        ...
                        .then(function(response) {
                            $.each(response, function(key, value) {
                                ...
                                if (value.validation_endpoint.search("incore") > 0) {
                                    link_provider('btn-incore', value.auth_link);
                                }
