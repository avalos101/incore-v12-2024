...
#################################################################################
from incore import api, models, fields, tools, _
...
class Website(models.Model):
    ...
    def get_config_settings_values(self):
        ...
        if stock_config_values:
            res = {
                ...
                'wk_stock_location_ids': stock_config_values.wk_stock_location_ids,
    ...
    def stock_qty_validate(self, product_id):
        ...
        if product_id:
            ...
            elif config_vals.get('wk_warehouse_type') == 'several':
                stock_location_ids = config_vals.get('wk_stock_location_ids')
                copy_context.update({'location': stock_location_ids.ids})
