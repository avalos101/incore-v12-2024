...
from incore.addons.payment_payulatam_bi.controllers.main import PayuLatamController
from incore.tools import mute_logger


@incore.tests.common.at_install(False)
@incore.tests.common.post_install(False)
...
class PayuLatamForm(PayuLatamCommon):
    ...
    @mute_logger('incore.addons.payment_payulatam_bi.models.payulatam', 'ValidationError')
