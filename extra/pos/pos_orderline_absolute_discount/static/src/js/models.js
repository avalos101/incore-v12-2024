incore.define('pos_absolute_discount.models', function(require){
    ...
    models.Orderline = models.Orderline.extend({
        ...
        apply_ms_data: function(data) {
            // This methods is added for compatibility with module https://www.incore.co/apps/modules/12.0/pos_multi_session/
