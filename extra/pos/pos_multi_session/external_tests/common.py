# Copyright 2016-2017  <https://incore.co/team/yelizariev>
# Copyright 2016 Dinar Gabbasov <https://incore.co/team/GabbasovDinar>
...
PORT = os.environ.get('INCORE_PORT') or '80'
DATABASE = os.environ.get('DATABASE')
ADMIN_LOGIN = "admin"
ADMIN_PASSWORD = "admin"
MAIN_DOMAIN = os.environ.get('INCORE_DOMAIN') or 'localhost'
...
class ExternalTestCase(unittest2.TestCase):
    ...
    def phantom_js_multi(self, sessions, commands, timeout=60, **kw):
        ...
        options = {
            # since 10.0 we use incore with --workers=1 + nginx,
    ...
    # Copy-paste from incore/tests/common.py
