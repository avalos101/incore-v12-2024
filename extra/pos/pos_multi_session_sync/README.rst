...
The module is used for `Sync POS orders across multiple sessions <https://apps.incore.co/apps/modules/12.0/pos_multi_session>`__. It provides the synchronization for POS multi-session and allows to use a separate sync server for data storage and processing.
...
* `IT-Projects LLC <https://it-projects.info>`__
      ...
      at `incore apps store <https://apps.incore.co/apps/modules/12.0/pos_multi_session_sync/>`__.
...
HTML Description: https://apps.incore.co/apps/modules/12.0/pos_multi_session_sync/
