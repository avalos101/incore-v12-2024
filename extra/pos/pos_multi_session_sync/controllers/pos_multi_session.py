...
try:
    ...
    _logger.error('pos_multi_session_sync inconsisten with incore version')
    BusController = object


class Controller(BusController):

    @incore.http.route('/pos_multi_session_sync/update', type="json", auth="public")
    ...
    @incore.http.route('/pos_multi_session/test/gc', type="http", auth="user")
