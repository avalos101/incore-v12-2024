...
class PosOrder(models.Model):
    ...
    delivery_type = fields.Many2one('res.users', string='Vendedor', readonly=True)
...
class DeliveryMethods(models.Model):
    ...
    enable_delivery = fields.Boolean(string='Habilitar Vendedores')
    delivery_methods = fields.Many2many('res.users', string='Vendedores')
