...
try:
    from incore.addons.hw_escpos.escpos import escpos
    from incore.addons.hw_escpos.controllers.main import EscposProxy
    from incore.addons.hw_escpos.controllers.main import EscposDriver
    from incore.addons.hw_escpos.escpos.printer import Network
    import incore.addons.hw_proxy.controllers.main as hw_proxy
except ImportError:
    EscposProxy = object
    EscposDriver = object
