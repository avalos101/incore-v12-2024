...
* Install the pos_printer_network module on inCore instance
...
Arabic, Japanese, Chinese and Korean `are not officially supported <https://github.com/incore/incore/issues/25007#issuecomment-395700893>`_. Possible workarounds are:

* `Modify posbox source <https://incore-development.readthedocs.io/en/latest/admin/posbox/administrate-posbox.html>`_ by adding encoding of your language to `encode_char method <https://github.com/incore/incore/blob/21064c7de8867c9217d274cb83ff589c8ebcac75/addons/hw_escpos/escpos/escpos.py#L745-L765>`_
