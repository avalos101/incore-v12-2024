$(document).ready(function () {
  ...
  $('#subscribe').on('click', function () {
      ...
      if(required) {
        document.getElementById("contact_message").innerHTML = "Sorry, We need a Email Id for Subscription. Please complete all of the required fields.";
        ...
        $.ajax({
            ...
            success: function (data) {
              document.getElementById("contact_message").innerHTML = "YOUR SUBSCRIPTION HAS BEEN SENT SUCCESSFULLY";
