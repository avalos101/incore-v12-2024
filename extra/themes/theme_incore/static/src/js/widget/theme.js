incore.define('website.theme_custom', function (require) {
'use strict';
...
Theme.include({
    xmlDependencies: (Theme.prototype.xmlDependencies || [])
        .concat(['/theme_incore/static/src/xml/website_editor.xml']),
    events: {
        ...
        colorpicker.on('colorpicker:saved', this, function (ev) {
            ...
            // TODO improve to be more efficient
                ...
                if(colorName === 'incore'){
		            ...
		            var baseURL = '/incore_customize/static/src/scss/options/colors/color_picker.scss';                                
                     		self._rpc({
							    ...
							    self._rpc({
								    ...
								    params: {
								        url: '/incore_customize/static/src/scss/options/colors/color_picker.scss',
