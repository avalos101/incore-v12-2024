incore.define('incore_customize.website_multi_editor', function (require) {
    'use strict';
    ...
    var brand_multi_tab_configure = options.Class.extend({
    popup_template_id: "editor_new_brand_multi_tab_configure_template",
    popup_title: _t("Select Collection"),
    select_collection: function (type, value) {
        var self = this;
        var def = wUtils.prompt({
    ...
    options.registry.s_brand_multi_with_header = brand_multi_tab_configure.extend({
        cleanForSave: function () {
