incore.define('incore_customize.front_js',function(require){
    'use strict';
            ...
            if (!self.editableMode) {
                $.get("/shop/get_product_brand_slider", {
                    ...
                    if (data) {
                        ...
                        $.getScript("/incore_customize/static/src/js/owl.carousel.min.js");
            ...
            if(!self.editableMode){
                $.get("/shop/get_product_snippet_content",{
                    ...
                    if(data){
                        ...
                        //$.getScript('incore_customize/static/src/js/frontend_product_quick_view_js.js');
                    }
                });
            }
        }
