...
from incore.addons.website_blog.controllers.main import WebsiteBlog
...
class WebsiteBlog(WebsiteBlog):
    ...
    def get_blog_content_data(self, **post):
        ...
        return request.render("incore_customize.blog_slider_content", value)
    ...
    def get_latest_blog_snip_content(self,**post):
        ...
        return request.render("incore_customize.blog_content",value)
