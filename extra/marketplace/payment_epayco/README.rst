...
.. |badge2| image:: https://img.shields.io/badge/licence-AGPL--3-blue.png
    ...
    :alt: License: AGPL-3
.. |badge3| image:: https://img.shields.io/badge/github-epayco%2Fincore_ePayco-lightgray.png?logo=github
    :target: https://github.com/epayco/incore_ePayco/tree/12.0/payment_epayco
    :alt: epayco/incore_ePayco
...
1. Agregar el directorio clonado de este repositorio a la ruta de addons de la instancia de incore.
...
Bugs are tracked on `GitHub Issues <https://github.com/epayco/incore_ePayco/issues>`_.
In case of trouble, please check there if your issue has already been reported.
If you spotted it first, help us smashing it by providing a detailed and welcomed
`feedback <https://github.com/epayco/incore_ePayco/issues/new?body=module:%20payment_epayco%0Aversion:%2012.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `epayco/incore_ePayco <https://github.com/epayco/incore_ePayco/tree/12.0/payment_epayco>`_ project on GitHub.
