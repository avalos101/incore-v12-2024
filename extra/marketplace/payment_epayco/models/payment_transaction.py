...
class PaymentTransaction(models.Model):
    ...
    def _get_epayco_tx_state(self, x_cod_transaction_state):
        """Get and return the corresponding state for incore transaction
