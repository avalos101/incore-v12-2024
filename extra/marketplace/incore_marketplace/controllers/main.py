...
class AuthSignupHome(incore.addons.web.controllers.main.Home):
    ...
    def web_login(self, *args, **kw):
        ...
        if request.httprequest.method == 'POST' and request.env.user.sudo().has_group('incore_marketplace.marketplace_draft_seller_group'):
    ...
    def seller_signup_form(self, *args, **kw):
        ...
        return request.render('incore_marketplace.mp_seller_signup', qcontext)
...
class website_marketplace_dashboard(http.Controller):
    ...
    def mp_terms_and_conditions(self,**post):
        ...
        return request.env.ref("incore_marketplace.mp_t_and_c_modal_template").render({'mp_t_and_c':mp_t_and_c,},engine='ir.qweb')
    ...
    def become_seller(self, **post):
        ...
        return request.render('incore_marketplace.convert_user_into_seller',values)
    ...
    def submit_as_seller(self, **post):
        ...
        if country_id and url_handler:
            ...
            draft_seller_group_id = request.env['ir.model.data'].get_object_reference('incore_marketplace', 'marketplace_draft_seller_group')[1]
    ...
    def account(self):
        seller_dashboard_menu_id = request.env[
            'ir.model.data'].get_object_reference('incore_marketplace', 'wk_seller_dashboard')[1]
...
class MarketplaceSellerProfile(http.Controller):
    ...
    def seller(self, seller_id=None, seller_url_handler=None, page=0, category=None, search='', ppg=False, **post):
        ...
        return request.render("incore_marketplace.mp_seller_profile", values)
    ...
    def seller_profile_recently_product(self, seller_id, page=0, category=None, search='', ppg=False, **post):
        ...
        return request.env.ref('incore_marketplace.shop_recently_product').render(values, engine='ir.qweb')
    ...
    def user_avatar(self, partner_id,model_name, field_name, **post):
        status, headers, content = binary_content(
            model=model_name, id=partner_id, field=field_name, default_mimetype='image/png', env=request.env(user=incore.SUPERUSER_ID))

        if not content:
            img_path = incore.modules.get_module_resource(
    ...
    def load_mp_all_seller(self, page=0, search='', ppg=False, **post):
        ...
        return request.render("incore_marketplace.sellers_list", values)
...
class MarketplaceSellerShop(http.Controller):
    ...
    def seller_shop(self, shop_url_handler, page=0, category=None, search='', ppg=False, **post):
        ...
        return request.render("incore_marketplace.mp_seller_shop", values)
    ...
    def mp_sell(self, redirect=None, **post):
        ...
        return request.render("incore_marketplace.wk_mp_seller_landing_page", values)
    ...
    def load_mp_all_seller_shop(self, page=0, search='', ppg=False, **post):
        ...
        return request.render("incore_marketplace.seller_shop_list", values)
...
class SellerReview(http.Controller):
    ...
    def load_seller_review(self, seller_id, offset=0, limit=False, sort_by="recent", filter_by=-1, **kwargs):
        ...
        return request.env.ref("incore_marketplace.wk_seller_review_template").render(values, engine='ir.qweb')
...
class TrackSol(http.Controller):
    ...
    def track_order_line(self, sol_id, **kwargs):
        ...
        return request.env.ref("incore_marketplace.marketplace_order_line_info").render(values, engine='ir.qweb')
...
class MarketplaceMail(http.Controller):
    ...
    def mp_chatter_json(self, res_model='', res_id=None, message='', **kw):
        ...
        if data:
            return request.env.ref("incore_marketplace.mp_chatter_mail_append").render(data, engine='ir.qweb')
        else:
            return False
