...
class SaleOrderLine(models.Model):
	...
	def action_view_delivery(self):
		...
		'''
		action = self.env.ref('incore_marketplace.marketplace_stock_picking_action').read()[0]
		...
		if len(pickings) > 1:
			...
			action['views'] = [(self.env.ref('incore_marketplace.marketplace_picking_stock_modified_form_view').id, 'form')]
