...
from incore.exceptions import except_orm, Warning, RedirectWarning
...
class ProductTemplate(models.Model):
    ...
    activity_date_deadline = fields.Date(
        ...
        groups="base.group_user,incore_marketplace.marketplace_seller_group")
    ...
    def mp_action_view_sales(self):
        ...
        tree_view_id = self.env.ref('incore_marketplace.wk_seller_product_order_line_tree_view')
        form_view_id = self.env.ref('incore_marketplace.wk_seller_product_order_line_form_view')
        return {
            'name': action.name,
            'help': action.help,
            'type': action.type,
