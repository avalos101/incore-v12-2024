        ...
        if seller_id and seller_id.payment_method:
            ...
            try:
                payment_method_cheque_id = self.env['ir.model.data'].get_object_reference(
                    'incore_marketplace', 'marketplace_seller_payment_method_data1')
    ...
    def do_request(self):
        ...
        if self.validate_payment_request():
            ...
            seller_payment_menu_id = self.env[
                'ir.model.data'].get_object_reference('incore_marketplace', 'wk_seller_payment_method')[1]
            seller_payment_action_id = self.env[
                'ir.model.data'].get_object_reference('incore_marketplace', 'wk_seller_payment_action')[1]
            return {
